...
(function (FG) {
  ...
  const MIST_LAKE_FISH = [
    ...
    /* --- 優良 --- */
    { id: 'ml_trout', name: '虹鱒', rarity: 'good', shape: 'wide', scale: .84, pattern: 'spot', mult: 0.985, minLen: 22, maxLen: 45,
    ...
    { id: 'ml_bass', name: '黑鱸', rarity: 'good', shape: 'normal', scale: .9, pattern: 'band', mult: 1.08, minLen: 25, maxLen: 50,
      ...
      desc: '掠食性強，咬餌的瞬間手感十足。' },
    { id: 'ml_whitefish', name: '湖白鮭', rarity: 'good', shape: 'long', scale: .86, pattern: 'saddle', mult: 0.936, minLen: 20, maxLen: 42,
  ...
  const FJORD_FISH = [
    /* --- 雜物 --- */
    { id: 'fj_bottle', name: '密封潮汐瓶', rarity: 'junk', junkArt: 'fj_tidebottle', mult: 0.0554, minLen: 12, maxLen: 24, unit: 'cm', desc: '厚玻璃裡困著一小撮橘金海藻和捲起的紙條，瓶口封蠟還完整。' },
    { id: 'fj_can',    name: '褪色浮標牌', rarity: 'junk', junkArt: 'fj_buoytag', mult: 0.0388, minLen: 8, maxLen: 15, unit: 'cm', desc: '橘色油漆被鹽霧磨成斑駁的粉色，編號只剩最後一碼。' },
    { id: 'fj_net',    name: '藤壺繫纜扣', rarity: 'junk', junkArt: 'fj_cleat', mult: 0.0499, minLen: 30, maxLen: 80, unit: 'cm', desc: '斷纜仍纏在鐵扣上，縫裡塞滿白色藤壺與海藻。' },

    /* --- 普通 --- */
    { id: 'fj_sardine', name: '霞光沙丁', rarity: 'common', shape: 'torpedo', scale: .72, pattern: 'band', mult: 0.528, minLen: 10, maxLen: 24,
      colors: { body: '#9fb8c6', back: '#4c6b7d', belly: '#f2f6f8', fin: '#7893a4', pattern: '#d8a45c' },
      desc: '夕陽下整群翻身時，海面像撒了一把金箔。' },
    { id: 'fj_goby', name: '岩礁鰕虎', rarity: 'common', shape: 'long', scale: .66, pattern: 'spot', mult: 0.477, minLen: 8, maxLen: 18,
      colors: { body: '#a8846a', back: '#5f4433', belly: '#e6d6c2', fin: '#856248', pattern: '#3f2d20' },
      desc: '死守自己那一塊岩縫，兇得很。' },
    { id: 'fj_anchovy', name: '金邊鯷', rarity: 'common', shape: 'long', scale: .64, pattern: 'stripe', mult: 0.494, minLen: 7, maxLen: 16,
      colors: { body: '#a9c0cc', back: '#52707f', belly: '#f4f8fa', fin: '#7e98a6', pattern: '#e0b25f' },
      desc: '整群壓在船底下的時候，海面看起來會自己發光。' },
    { id: 'fj_horsemackerel', name: '竹筴魚', rarity: 'common', shape: 'long', scale: .74, pattern: 'band', mult: 0.553, minLen: 14, maxLen: 30,
      colors: { body: '#86a1a8', back: '#445f68', belly: '#eef3f4', fin: '#6a848c', pattern: '#cfa15a' },
      desc: '側線上有一排硬棘，摸下去像鋸子。' },
    { id: 'fj_flounder', name: '崖底鰈', rarity: 'common', shape: 'flat', scale: .78, pattern: 'speck', mult: 0.576, minLen: 15, maxLen: 34,
      colors: { body: '#8a7a5e', back: '#4d422f', belly: '#e8ded0', fin: '#6d6049', pattern: '#3a3124' },
      desc: '兩隻眼睛長在同一側，貼著砂地一動也不動。' },
    { id: 'fj_wrasse', name: '霞紋隆頭魚', rarity: 'common', shape: 'flat', scale: .72, pattern: 'band2', mult: 0.52, minLen: 12, maxLen: 26,
      colors: { body: '#4f8a8f', back: '#275257', belly: '#e6d9b8', fin: '#d97a4a', pattern: '#ffd28a' },
      desc: '天一黑就在砂裡挖個洞把自己埋起來睡覺。' },

    /* --- 優良 --- */
    { id: 'fj_scorpion', name: '赤鮋', rarity: 'good', shape: 'flat', scale: .88, pattern: 'spot', mult: 0.891, minLen: 18, maxLen: 38,
      special: ['spike'],
      colors: { body: '#c4553f', back: '#7d2c22', belly: '#f0c8a8', fin: '#9c3d2e', pattern: '#5e1f18' },
      desc: '鰭上有毒棘，處理時務必小心。' },
    { id: 'fj_mackerel', name: '條紋鯖', rarity: 'good', shape: 'torpedo', scale: .92, pattern: 'stripe', mult: 0.959, minLen: 24, maxLen: 48,
      colors: { body: '#6d93a6', back: '#2f5265', belly: '#eef4f7', fin: '#4d7387', pattern: '#1f3a49' },
      desc: '速度極快，中鉤後會把線拉得筆直。' },
    { id: 'fj_bonito', name: '齒鰹', rarity: 'good', shape: 'wide', scale: .9, pattern: 'stripe', mult: 0.933, minLen: 25, maxLen: 52,
      colors: { body: '#55788f', back: '#26414f', belly: '#eef2f5', fin: '#3d5f72', pattern: '#1c333f' },
      desc: '一停下來就會沉，所以牠一輩子沒有真正休息過。' },
    { id: 'fj_needlefish', name: '針嘴鱵', rarity: 'good', shape: 'long', scale: .9, pattern: 'chevron', mult: 0.856, minLen: 25, maxLen: 55,
      colors: { body: '#93aeb8', back: '#4c6773', belly: '#f6f9fa', fin: '#ffc46a' },
      desc: '下顎細長如針。受驚時會貼著海面連續彈跳。' },
    { id: 'fj_grouper', name: '岩壁石斑', rarity: 'good', shape: 'wide', scale: .86, pattern: 'spot', mult: 0.993, minLen: 22, maxLen: 48,
      colors: { body: '#7a6a52', back: '#43382a', belly: '#ddd0b4', fin: '#5d5140', pattern: '#2e2519' },
      desc: '一輩子守著同一個岩洞，體色會慢慢染成岩壁的顏色。' },

    /* --- 稀有 --- */
    { id: 'fj_seabream', name: '落日真鯛', rarity: 'rare', shape: 'flat', scale: 1.02, pattern: 'speck', mult: 2.17, minLen: 30, maxLen: 70,
      colors: { body: '#e08a86', back: '#a24a4c', belly: '#fbe3dc', fin: '#c26a68', pattern: '#7fb9d6' },
      desc: '峽灣落日時分才會靠岸，紅得像被夕陽染過。' },
    { id: 'fj_cutlass', name: '銀刀魚', rarity: 'rare', shape: 'slim', scale: 1.14, pattern: 'none', mult: 2.38, minLen: 60, maxLen: 130,
      colors: { body: '#d6e2ea', back: '#8ea3b3', belly: '#ffffff', fin: '#b2c4d0' },
      desc: '像一把豎立的長刀，直挺挺地懸在水中。' },
    { id: 'fj_amberjack', name: '霞色紅甘', rarity: 'rare', shape: 'wide', scale: 1.04, pattern: 'band', mult: 2.27, minLen: 40, maxLen: 90,
      colors: { body: '#7f8f6f', back: '#4a5840', belly: '#f2ead0', fin: '#5f6f52', pattern: '#e8b45c' },
      desc: '從眼睛拉到尾柄的那道金線，在夕照下會整條亮起來。' },
    { id: 'fj_lionfish', name: '焰鰭蓑鮋', rarity: 'rare', shape: 'flat', scale: 1.0, pattern: 'stripe', mult: 2.12, minLen: 22, maxLen: 48,
      special: ['spike'],
    ...
    /* --- 傳說 --- */
    { id: 'fj_oarfish', name: '霞帶皇帶魚', rarity: 'legend', shape: 'long', scale: 1.22, pattern: 'none', mult: 19.3, minLen: 200, maxLen: 420,
      special: ['glow'],
    ...
    { id: 'fj_ray', name: '霞光魟', rarity: 'legend', shape: 'ray', scale: 1.2, pattern: 'spot', mult: 18.6, minLen: 100, maxLen: 220,
      special: ['glow'],
    ...
    /* --- 魚王 --- */
    { id: 'fj_king_helio', name: '落日巨鮪「赫利歐」', rarity: 'king', shape: 'tuna', scale: 1.34, pattern: 'band2', mult: 67.7, minLen: 200, maxLen: 340,
      special: ['glow', 'finlet'],
  ...
  const SHRINE_FISH = [
    /* --- 雜物 --- */
    { id: 'sk_ema',  name: '舊繪馬',     rarity: 'junk', junkArt: 'ema',  mult: 0.0545, minLen: 12, maxLen: 20, unit: 'cm', desc: '墨跡被水泡開了，只看得出最後一個「願」字。' },
    { id: 'sk_can',  name: '沉水鈴鐺',   rarity: 'junk', junkArt: 'sk_bell', mult: 0.0424, minLen: 8, maxLen: 15, unit: 'cm', desc: '朱繩早已褪白，銅鈴裡還卡著一粒黑色小石子，拉起來也不響。' },
    { id: 'sk_moss', name: '褪色紙鶴',   rarity: 'junk', junkArt: 'sk_crane', mult: 0.0362, minLen: 20, maxLen: 55, unit: 'cm', desc: '紙纖維吸飽了水，翅尖黏著幾片櫻花色的藻膜。' },

    /* --- 普通 --- */
    { id: 'sk_ayu', name: '香魚', rarity: 'common', shape: 'torpedo', scale: .74, pattern: 'none', mult: 0.482, minLen: 12, maxLen: 30,
      colors: { body: '#8fa88c', back: '#4e6a52', belly: '#f0f4ea', fin: '#6d8670' },
      desc: '身上帶著西瓜般的清香，一年就結束一生。' },
    { id: 'sk_oikawa', name: '追河', rarity: 'common', shape: 'normal', scale: .7, pattern: 'stripe', mult: 0.471, minLen: 8, maxLen: 18,
      colors: { body: '#7f92a8', back: '#44546a', belly: '#f2f5f8', fin: '#c85a7a', pattern: '#5f7fa8' },
      desc: '繁殖期的雄魚會換上紅紫相間的婚姻色，是溪裡最花俏的一段日子。' },
    { id: 'sk_funa', name: '真鮒', rarity: 'common', shape: 'round', scale: .74, pattern: 'scale', mult: 0.503, minLen: 12, maxLen: 30,
      colors: { body: '#9aa38a', back: '#5b6350', belly: '#e8ecd8', fin: '#77806a', pattern: '#7d8770' },
      desc: '「釣魚始於鮒、終於鮒」——神社前的老人這樣教小孩。' },
    { id: 'sk_haze', name: '真鰕虎', rarity: 'common', shape: 'long', scale: .68, pattern: 'spot', mult: 0.45, minLen: 8, maxLen: 20,
      colors: { body: '#a89478', back: '#5f5340', belly: '#ece2cc', fin: '#867059', pattern: '#4a3d2c' },
      desc: '退潮後留在灘上的水窪裡，一戳就彈起來。' },
    { id: 'sk_tanago', name: '虹鱊', rarity: 'common', shape: 'flat', scale: .64, pattern: 'band', mult: 0.524, minLen: 5, maxLen: 12,
      colors: { body: '#8fb0c4', back: '#4a6a80', belly: '#f4f0e2', fin: '#d88a9c', pattern: '#5fd0b8' },
      desc: '把卵產進河蚌的鰓裡。小得像一枚會游的和菓子。' },
    { id: 'sk_dojo', name: '泥鰍', rarity: 'common', shape: 'long', scale: .7, pattern: 'speck', mult: 0.46, minLen: 10, maxLen: 22,
      special: ['whisker'],
      colors: { body: '#6e6350', back: '#3d3628', belly: '#c8bfa4', fin: '#57503f', pattern: '#918872' },
      desc: '天氣要變的時候會浮上來換氣，比氣象預報準。' },

    /* --- 優良 --- */
    { id: 'sk_yamame', name: '山女鱒', rarity: 'good', shape: 'wide', scale: .84, pattern: 'band2', mult: 0.842, minLen: 18, maxLen: 40,
      colors: { body: '#7f8f9c', back: '#46545f', belly: '#f2f0e6', fin: '#63727e', pattern: '#3a4650' },
      desc: '溪流的女王。側面那排橢圓斑叫「小判紋」。' },
    { id: 'sk_iwana', name: '岩魚', rarity: 'good', shape: 'wide', scale: .86, pattern: 'spot', mult: 0.864, minLen: 20, maxLen: 45,
      colors: { body: '#6a6f5e', back: '#3a4034', belly: '#f0e4cc', fin: '#525848', pattern: '#f2e8d0' },
      desc: '住在溪流最上游、瀑布也上得去的地方。山裡的人說牠會變成人。' },
    { id: 'sk_kurodai', name: '黑鯛', rarity: 'good', shape: 'flat', scale: .88, pattern: 'stripe', mult: 0.886, minLen: 22, maxLen: 50,
      colors: { body: '#6b7078', back: '#33383f', belly: '#dfe3e6', fin: '#4c5259', pattern: '#282d33' },
      desc: '極度謹慎，能認出釣線。汽水域的老油條。' },
    { id: 'sk_suzuki', name: '鱸', rarity: 'good', shape: 'normal', scale: .92, pattern: 'speck', mult: 0.908, minLen: 30, maxLen: 65,
      colors: { body: '#93a6b2', back: '#4f6270', belly: '#f4f7f9', fin: '#73868f', pattern: '#3d4d58' },
      desc: '一生會換三個名字，長到這個尺寸才配叫「鱸」。' },
    { id: 'sk_unagi', name: '青鰻', rarity: 'good', shape: 'slim', scale: .9, pattern: 'none', mult: 0.826, minLen: 35, maxLen: 80,
      colors: { body: '#4f5f4a', back: '#283224', belly: '#d4d8be', fin: '#3d4a39' },
      desc: '沒有人在這條河裡看過牠產卵——牠們會一路游到幾千公里外的海溝去。' },

    /* --- 稀有 --- */
    { id: 'sk_nishikigoi', name: '三色錦鯉', rarity: 'rare', shape: 'normal', scale: 1.02, pattern: 'spot', mult: 2.12, minLen: 30, maxLen: 70,
      special: ['whisker'],
      colors: { body: '#f4f0ea', back: '#cfc6ba', belly: '#ffffff', fin: '#e0d6ca', pattern: '#c8392f' },
      desc: '神社放生池滿出來時流進潟湖的。牠們在這裡長得比池子裡大兩倍。' },
    { id: 'sk_kinme', name: '金目鯛', rarity: 'rare', shape: 'flat', scale: 1.0, pattern: 'saddle', mult: 2.17, minLen: 25, maxLen: 55,
      colors: { body: '#d0483f', back: '#8a2620', belly: '#f6d4c4', fin: '#b03a32', eyeWhite: '#ffd766', pupil: '#20140c' },
      desc: '那雙金色的大眼睛在燈下會整個亮起來，像兩枚小判。' },
    { id: 'sk_ishidai', name: '石鯛', rarity: 'rare', shape: 'flat', scale: 1.0, pattern: 'stripe', mult: 2.09, minLen: 25, maxLen: 60,
      colors: { body: '#c8cdd2', back: '#7d848c', belly: '#f2f5f7', fin: '#9aa1a8', pattern: '#20262c' },
      desc: '七條黑橫紋。牙齒能咬碎貝殼，也能咬斷鉤子。' },
    { id: 'sk_sakuramasu', name: '櫻鱒', rarity: 'rare', shape: 'wide', scale: 1.04, pattern: 'speck', mult: 2.21, minLen: 35, maxLen: 75,
    ...
    /* --- 傳說 --- */
    { id: 'sk_ningyo', name: '人魚', rarity: 'legend', shape: 'flat', scale: 1.18, pattern: 'scale', mult: 21.2, minLen: 60, maxLen: 130,
      special: ['glow'],
      ...
      desc: '不該吃的那種魚。' },
    { id: 'sk_shinshi', name: '神使白魚', rarity: 'legend', shape: 'torpedo', scale: 1.16, pattern: 'none', mult: 20.6, minLen: 50, maxLen: 110,
      special: ['glow'],
    ...
    /* --- 魚王 --- */
    { id: 'sk_king_yahiro', name: '淵之主「八尋」', rarity: 'king', shape: 'dragon', scale: 1.32, pattern: 'scale', mult: 84.3, minLen: 180, maxLen: 300,
  ...
  const FROST_FISH = [
    /* --- 雜物 --- */
    { id: 'fr_ice',  name: '浮冰碎塊',   rarity: 'junk', junkArt: 'ice',  mult: 0.0348, minLen: 20, maxLen: 60, unit: 'cm', desc: '拉上來就開始融化，最後什麼都不剩。' },
    { id: 'fr_can',  name: '結霜保溫瓶', rarity: 'junk', junkArt: 'fr_thermos', mult: 0.0475, minLen: 8, maxLen: 15, unit: 'cm', desc: '瓶身被冰殼封住，蓋子還拴著一小段裂開的藍色腕帶。' },
    { id: 'fr_rope', name: '冰釣亮片',   rarity: 'junk', junkArt: 'fr_jig', mult: 0.0382, minLen: 30, maxLen: 90, unit: 'cm', desc: '銀亮魚形假餌黏著冰屑，三叉鉤已被凍鈍。' },

    /* --- 普通 --- */
    { id: 'fr_smelt', name: '冰下胡瓜魚', rarity: 'common', shape: 'torpedo', scale: .66, pattern: 'none', mult: 0.407, minLen: 8, maxLen: 20,
      colors: { body: '#b8ccd6', back: '#6d8794', belly: '#f4fafc', fin: '#94aab6' },
      desc: '冰釣最常見的收穫，小孩在冰洞旁一整天能釣上百條。' },
    { id: 'fr_whitefish', name: '霜鱗白鮭', rarity: 'common', shape: 'long', scale: .8, pattern: 'scale', mult: 0.464, minLen: 18, maxLen: 38,
      colors: { body: '#c8d8e2', back: '#7f97a6', belly: '#fbfdfe', fin: '#a3b8c4', pattern: '#dfe9f0' },
      desc: '離水幾秒鱗片就結霜，看起來像裹了一層糖。' },
    { id: 'fr_perch', name: '藍紋河鱸', rarity: 'common', shape: 'normal', scale: .78, pattern: 'stripe', mult: 0.442, minLen: 14, maxLen: 32,
      colors: { body: '#5f7f9c', back: '#2f4a63', belly: '#e6eef4', fin: '#4a6884', pattern: '#23394d' },
      desc: '冰層下光線少，牠的橫紋比溫帶的同類深上一號。' },
    { id: 'fr_ruffe', name: '冰砂杜父魚', rarity: 'common', shape: 'round', scale: .7, pattern: 'speck', mult: 0.384, minLen: 8, maxLen: 18,
      colors: { body: '#7c8a86', back: '#444f4d', belly: '#d8e0dc', fin: '#5f6c68', pattern: '#3a4442' },
      desc: '趴在湖底的碎石上，不動的時候跟砂子一模一樣。' },
    { id: 'fr_dace', name: '雪腹雅羅魚', rarity: 'common', shape: 'normal', scale: .76, pattern: 'gradient', mult: 0.422, minLen: 15, maxLen: 34,
      colors: { body: '#a8bcc8', back: '#61798a', belly: '#f6fafc', fin: '#859cab' },
      desc: '腹部白得發亮，從冰洞往下看只看得見一片一片閃動的白。' },
    { id: 'fr_burbot', name: '冰穴江鱈', rarity: 'common', shape: 'long', scale: .84, pattern: 'speck', mult: 0.479, minLen: 22, maxLen: 48,
      special: ['whisker'],
      colors: { body: '#6f6a54', back: '#3b382a', belly: '#ccc8ae', fin: '#56513f', pattern: '#9a937a' },
      desc: '唯一在結冰季產卵的淡水鱈。越冷牠越活躍。' },

    /* --- 優良 --- */
    { id: 'fr_grayling', name: '藍鰭茴魚', rarity: 'good', shape: 'wide', scale: .86, pattern: 'band', mult: 0.769, minLen: 22, maxLen: 46,
      colors: { body: '#6f8fb0', back: '#3a5570', belly: '#eaf2f8', fin: '#8f6fc0', pattern: '#4a6a8c' },
      desc: '背鰭張開時像一面淡紫色的帆，只有離水的那一瞬間看得到。' },
    { id: 'fr_char', name: '極地紅點鮭', rarity: 'good', shape: 'wide', scale: .9, pattern: 'spot', mult: 0.823, minLen: 26, maxLen: 56,
      colors: { body: '#55707f', back: '#2d4450', belly: '#f4dcc4', fin: '#d4704e', pattern: '#ff9e70' },
      desc: '在這片死白裡，牠腹側那排橘點是唯一的暖色。' },
    { id: 'fr_pike', name: '冰河狗魚', rarity: 'good', shape: 'long', scale: .96, pattern: 'band2', mult: 0.855, minLen: 35, maxLen: 75,
      colors: { body: '#6f8470', back: '#3a4a3c', belly: '#d8e0d4', fin: '#4d5f50', pattern: '#a8bca8' },
      desc: '守在冰洞正下方，等著吞掉任何被光吸引過來的東西。' },
    { id: 'fr_lenok', name: '霜紋細鱗鮭', rarity: 'good', shape: 'normal', scale: .88, pattern: 'speck', mult: 0.784, minLen: 24, maxLen: 50,
      colors: { body: '#8a9aa4', back: '#4e5e68', belly: '#f0f4f6', fin: '#6d7d88', pattern: '#c4d2da' },
      desc: '鱗片細到摸起來像磨砂玻璃。' },
    { id: 'fr_sculpin', name: '甲殼杜父魚', rarity: 'good', shape: 'round', scale: .82, pattern: 'net', mult: 0.739, minLen: 16, maxLen: 34,
      special: ['spike'],
      colors: { body: '#7a6f7f', back: '#443c48', belly: '#ded6e0', fin: '#5e5563', pattern: '#a89ab0' },
      desc: '頭部覆著一層骨板，被冰塊砸到也不痛不癢。' },

    /* --- 稀有 --- */
    { id: 'fr_taimen', name: '冰河哲羅鮭', rarity: 'rare', shape: 'wide', scale: 1.04, pattern: 'spot', mult: 2.05, minLen: 50, maxLen: 110,
      colors: { body: '#7f6f5f', back: '#45392e', belly: '#eee0cc', fin: '#b45a4a', pattern: '#d88a6a' },
      desc: '淡水鮭裡最大的一支。會把落水的小型獸類一併吞掉。' },
    { id: 'fr_sturgeon', name: '霜背小鱘', rarity: 'rare', shape: 'wide', scale: 1.06, pattern: 'net', mult: 2.11, minLen: 55, maxLen: 120,
      special: ['spike', 'whisker'],
      colors: { body: '#8fb0bc', back: '#4c6d7a', belly: '#e6f2f6', fin: '#6d8f9c', pattern: '#b8dce8' },
      desc: '背上五列骨板結著霜，像一排小小的冰山。' },
    { id: 'fr_glasscarp', name: '透鱗玻璃魚', rarity: 'rare', shape: 'flat', scale: 1.0, pattern: 'none', mult: 1.98, minLen: 30, maxLen: 65,
      special: ['glow'],
      colors: { body: '#cfe4ee', back: '#93b4c6', belly: '#ffffff', fin: '#b0cddb', glow: '#a8dcf4' },
      desc: '整條魚半透明，對著光看得見裡面的骨架與心跳。' },
    { id: 'fr_bluetrout', name: '深藍湖鱒', rarity: 'rare', shape: 'normal', scale: 1.0, pattern: 'speck', mult: 2.02, minLen: 35, maxLen: 72,
    ...
    /* --- 傳說 --- */
    { id: 'fr_aurora', name: '極光鱗鮭', rarity: 'legend', shape: 'wide', scale: 1.18, pattern: 'scale', mult: 23, minLen: 100, maxLen: 200,
      special: ['glow'],
      ...
      desc: '只在極光下浮出的綠色魚群。' },
    { id: 'fr_wraith', name: '冰隙白影', rarity: 'legend', shape: 'long', scale: 1.2, pattern: 'none', mult: 22.2, minLen: 120, maxLen: 240,
      special: ['glow'],
    ...
    /* --- 魚王 --- */
    { id: 'fr_king_kold', name: '霜牙巨狗魚「寇爾德」', rarity: 'king', shape: 'pike', scale: 1.32, pattern: 'spot', mult: 99.8, minLen: 180, maxLen: 320,
  ...
  const LOTUS_FISH = [
    /* --- 雜物 --- */
    { id: 'lr_porcelain', name: '青花碎碗',   rarity: 'junk', junkArt: 'porcelain', mult: 0.0418, minLen: 8,  maxLen: 22, unit: 'cm', desc: '缺了一角。碗底還看得出半個模糊的字。' },
    { id: 'lr_can',       name: '酒罈木塞',   rarity: 'junk', junkArt: 'lr_jarstopper', mult: 0.0333, minLen: 8, maxLen: 16, unit: 'cm', desc: '紅布封口褪成灰紫，木塞吸足江水後浮沉得像一顆小果實。' },
    { id: 'lr_caltrop',   name: '泡爛蓮蓬',   rarity: 'junk', junkArt: 'lr_lotuspod', mult: 0.0365, minLen: 25, maxLen: 80, unit: 'cm', desc: '深褐色的蓮孔裡塞著泥沙，長梗還纏著一圈細藻。' },

    /* --- 普通 --- */
    { id: 'lr_topmouth', name: '麥穗魚', rarity: 'common', shape: 'long', scale: .62, pattern: 'gradient', mult: 0.374, minLen: 4, maxLen: 11,
      colors: { body: '#9aa8a4', back: '#5a6a6a', belly: '#e4eae4', fin: '#7c8a88' },
      desc: '整條江裡最不值錢也最抓不完的一種。小孩用竹篩就能撈起一整碗。' },
    { id: 'lr_bitterling', name: '彩鰟鮍', rarity: 'common', shape: 'flat', scale: .58, pattern: 'band', mult: 0.402, minLen: 3, maxLen: 8,
      colors: { body: '#8fa2a8', back: '#4f6470', belly: '#eef2f0', fin: '#6f858c', pattern: '#6a8f9c' },
      desc: '產卵時會把卵託給河蚌照顧。體側那道藍線在陽光下會轉色。' },
    { id: 'lr_hemiculter', name: '白鰷', rarity: 'common', shape: 'torpedo', scale: .74, pattern: 'none', mult: 0.385, minLen: 10, maxLen: 22,
      colors: { body: '#c0ccc8', back: '#76888a', belly: '#f6faf8', fin: '#9aa8a6' },
      desc: '成群在水面下十公分處游，太陽一照整片江面像撒了碎銀。' },
    { id: 'lr_crucian', name: '土鯽', rarity: 'common', shape: 'round', scale: .8, pattern: 'scale', mult: 0.421, minLen: 12, maxLen: 30,
      colors: { body: '#8d8a68', back: '#54523c', belly: '#ded8b8', fin: '#6d6a50', pattern: '#a8a480' },
      desc: '哪裡都活得下去。江水再濁，牠都還在。' },
    { id: 'lr_loach', name: '青泥鰍', rarity: 'common', shape: 'long', scale: .78, pattern: 'speck', mult: 0.393, minLen: 10, maxLen: 24,
      special: ['whisker'],
      colors: { body: '#5f6a55', back: '#333a2c', belly: '#c4c8ac', fin: '#48513c', pattern: '#8a9478' },
      desc: '滑到抓不住。整個冬天埋在泥裡不動，開春再爬出來。' },
    { id: 'lr_yellowcat', name: '黃顙魚', rarity: 'common', shape: 'wide', scale: .7, pattern: 'none', mult: 0.41, minLen: 8, maxLen: 20,
      special: ['whisker'],
      colors: { body: '#a8903f', back: '#5f4f1e', belly: '#e8dca8', fin: '#8a7430' },
      desc: '背鰭前那根硬刺會扎人，江邊的孩子都被扎過一次才學會怎麼拿。' },

    /* --- 優良 --- */
    { id: 'lr_grass', name: '青草魚', rarity: 'good', shape: 'wide', scale: .92, pattern: 'scale', mult: 0.744, minLen: 30, maxLen: 75,
      colors: { body: '#7d8a66', back: '#454e35', belly: '#dee4c8', fin: '#5f6b4c', pattern: '#9aa880' },
      desc: '一天能吃掉自己體重一半的水草。江邊的水草到哪裡斷，就知道牠在哪裡。' },
    { id: 'lr_bream', name: '武昌魴', rarity: 'good', shape: 'flat', scale: .86, pattern: 'band', mult: 0.717, minLen: 20, maxLen: 45,
      colors: { body: '#9aa8b0', back: '#586a76', belly: '#eef2f4', fin: '#76888f', pattern: '#67797f' },
      desc: '側扁得像一片瓦。當地人說隔水就能認出牠游動的角度。' },
    { id: 'lr_culter', name: '翹嘴鮊', rarity: 'good', shape: 'torpedo', scale: .96, pattern: 'none', mult: 0.763, minLen: 30, maxLen: 70,
      colors: { body: '#b4c0be', back: '#5f7276', belly: '#f4f8f6', fin: '#8d9c9c' },
      desc: '嘴往上翹，專門從下往上撞水面的小魚。追餌時整條江面會炸開。' },
    { id: 'lr_xenocypris', name: '黃尾鯝', rarity: 'good', shape: 'normal', scale: .84, pattern: 'band', mult: 0.733, minLen: 18, maxLen: 40,
      colors: { body: '#a4aca0', back: '#5f6a5e', belly: '#eaeee4', fin: '#c8a848', pattern: '#7f8a7c' },
      desc: '只有尾鰭是黃的，其餘一片灰。在濁水裡就靠那點黃認同伴。' },
    { id: 'lr_sleeper', name: '沙塘鱧', rarity: 'good', shape: 'round', scale: .78, pattern: 'net', mult: 0.779, minLen: 10, maxLen: 22,
      special: ['spike'],
      colors: { body: '#6a6053', back: '#3a352b', belly: '#c8c0aa', fin: '#514a3e', pattern: '#8f8672' },
      desc: '趴在石縫裡等，一整天只動一次。動的那一次不會失手。' },

    /* --- 稀有 --- */
    { id: 'lr_mandarin', name: '花斑鱖', rarity: 'rare', shape: 'wide', scale: 1.0, pattern: 'spot', mult: 2, minLen: 25, maxLen: 60,
      colors: { body: '#a89050', back: '#5c4b22', belly: '#eee0b4', fin: '#7f6a34', pattern: '#2e2a1c' },
      desc: '「桃花流水鱖魚肥」寫的就是牠。只吃活魚，餌不動牠就不理。' },
    { id: 'lr_blackcarp', name: '墨背青魚', rarity: 'rare', shape: 'wide', scale: 1.06, pattern: 'saddle', mult: 1.96, minLen: 50, maxLen: 120,
      colors: { body: '#4a5560', back: '#1e252d', belly: '#c0c8cc', fin: '#333e48' },
      desc: '咽喉裡有一塊像磨盤的骨板，河蚌的殼在牠嘴裡會發出聲音。' },
    { id: 'lr_sucker', name: '胭脂魚', rarity: 'rare', shape: 'flat', scale: 1.04, pattern: 'band2', mult: 2.07, minLen: 40, maxLen: 100,
      colors: { body: '#d8b0a4', back: '#8a4a44', belly: '#f8e8de', fin: '#c25a4e', pattern: '#a8342c' },
      desc: '幼魚背鰭高得像一面帆，身上三道胭脂色斜帶。長大之後帆會收起來，帶也淡掉。' },
    { id: 'lr_eel', name: '江鰻', rarity: 'rare', shape: 'slim', scale: 1.0, pattern: 'none', mult: 1.94, minLen: 40, maxLen: 90,
    ...
    /* --- 傳說 --- */
    { id: 'lr_koi', name: '躍門金鯉', rarity: 'legend', shape: 'round', scale: 1.18, pattern: 'scale', mult: 25.3, minLen: 60, maxLen: 130,
      special: ['glow', 'horn'],
      ...
      desc: '額上已經長出角的雛形。' },
    { id: 'lr_salamander', name: '夜啼大鯢', rarity: 'legend', shape: 'long', scale: 1.22, pattern: 'spot', mult: 24.7, minLen: 80, maxLen: 180,
    ...
    /* --- 魚王 --- */
    { id: 'lr_king_dujiang', name: '江神白鱘「渡江」', rarity: 'king', shape: 'paddle', scale: 1.3, pattern: 'net', mult: 119, minLen: 250, maxLen: 520,
  ...
  const ABYSS_FISH = [
    /* --- 雜物 --- */
    { id: 'ab_bone',   name: '不明骨骸',     rarity: 'junk', junkArt: 'bone',   mult: 0.0304, minLen: 20, maxLen: 70, unit: 'cm', desc: '拼不出是什麼生物。排列方式讓人不太舒服。' },
    { id: 'ab_bottle', name: '裂殼深潛紀錄器', rarity: 'junk', junkArt: 'ab_logger', mult: 0.0402, minLen: 15, maxLen: 35, unit: 'cm', desc: '圓筒外殼裂開一道縫，指示燈卻仍隔幾秒閃一次綠光。' },
    { id: 'ab_can',    name: '斷裂聲納纜線', rarity: 'junk', junkArt: 'ab_cable', mult: 0.028, minLen: 8, maxLen: 16, unit: 'cm', desc: '黑色纜線捲成硬圈，斷口露出被水壓擠扁的彩色芯線。' },

    /* --- 普通 --- */
    { id: 'ab_lanternfish', name: '燈籠魚', rarity: 'common', shape: 'normal', scale: .68, pattern: 'speck', mult: 0.333, minLen: 6, maxLen: 16,
      special: ['glow'],
      colors: { body: '#2f3a4a', back: '#16202c', belly: '#4a5a6e', fin: '#26303e', pattern: '#7fe0ff', glow: '#4fb0d8' },
      desc: '全世界數量最多的脊椎動物之一，只是沒人看得到牠們。' },
    { id: 'ab_bristlemouth', name: '巨口鬚魚', rarity: 'common', shape: 'long', scale: .7, pattern: 'speck', mult: 0.323, minLen: 5, maxLen: 14,
      special: ['glow'],
      colors: { body: '#2a2f38', back: '#13161c', belly: '#3e4753', fin: '#1f242c', pattern: '#6fd0e8', glow: '#3f90b0' },
      desc: '身體只有一根手指長，嘴巴卻能張開到跟身體一樣寬。' },
    { id: 'ab_hatchetfish', name: '銀斧魚', rarity: 'common', shape: 'flat', scale: .66, pattern: 'none', mult: 0.359, minLen: 4, maxLen: 12,
      special: ['glow'],
      colors: { body: '#b8c6d2', back: '#5c6a78', belly: '#e8f0f6', fin: '#8fa0ae', glow: '#9fd8f0' },
      desc: '腹部的發光器會模擬上方微弱的天光，讓底下的掠食者看不見牠。' },
    { id: 'ab_snailfish', name: '深溝獅子魚', rarity: 'common', shape: 'round', scale: .7, pattern: 'gradient', mult: 0.344, minLen: 10, maxLen: 24,
      colors: { body: '#d8a8b0', back: '#8a5f6a', belly: '#f4dce0', fin: '#bc8a94' },
      desc: '沒有鱗片也沒有魚鰾，全身像一團果凍。海溝最深處的常住居民。' },
    { id: 'ab_cusk', name: '深海鼬魚', rarity: 'common', shape: 'slim', scale: .8, pattern: 'none', mult: 0.377, minLen: 18, maxLen: 40,
      colors: { body: '#4a5460', back: '#232a33', belly: '#8d99a6', fin: '#374049' },
      desc: '一輩子貼著海底泥面滑行，眼睛退化到只剩兩個凹點。' },
    { id: 'ab_tripodfish', name: '三腳架魚', rarity: 'common', shape: 'long', scale: .74, pattern: 'speck', mult: 0.35, minLen: 12, maxLen: 28,
      colors: { body: '#3f4a52', back: '#1e252b', belly: '#7d8a94', fin: '#2c353c', pattern: '#8fa8b4' },
      desc: '用三根特化的長鰭條站在泥上，面對水流一動也不動地等。' },

    /* --- 優良 --- */
    { id: 'ab_viperfish', name: '蝰魚', rarity: 'good', shape: 'long', scale: .9, pattern: 'speck', mult: 0.69, minLen: 20, maxLen: 45,
      special: ['spike', 'glow'],
      colors: { body: '#28323e', back: '#121820', belly: '#3f4c5a', fin: '#1c242e', pattern: '#7fe8d8', glow: '#4fc8b0' },
      desc: '牙齒長到閉不上嘴，只能維持著咬住空氣的姿勢。' },
    { id: 'ab_dragonfish', name: '黑巨口魚', rarity: 'good', shape: 'long', scale: .92, pattern: 'none', mult: 0.711, minLen: 22, maxLen: 48,
    ...
    { id: 'ab_grenadier', name: '長尾鱈', rarity: 'good', shape: 'long', scale: .94, pattern: 'net', mult: 0.655, minLen: 30, maxLen: 70,
      colors: { body: '#4e5a64', back: '#252d34', belly: '#96a4ae', fin: '#3a444c', pattern: '#6e7d88' },
      desc: '頭大尾細，像一顆頭後面拖著一條鞭子。' },
    { id: 'ab_fangtooth', name: '尖牙魚', rarity: 'good', shape: 'round', scale: .84, pattern: 'net', mult: 0.665, minLen: 12, maxLen: 28,
      special: ['spike'],
      colors: { body: '#3a3038', back: '#1a1418', belly: '#5e5158', fin: '#281f26', pattern: '#6d5c68' },
      desc: '相對體型而言，牠擁有全海洋最長的牙。頭骨上還特地開了兩個孔給下顎的牙收納。' },
    { id: 'ab_slickhead', name: '平頭魚', rarity: 'good', shape: 'wide', scale: .86, pattern: 'saddle', mult: 0.644, minLen: 25, maxLen: 55,
      colors: { body: '#333c46', back: '#171d24', belly: '#5b6874', fin: '#232b33' },
      desc: '受到驚嚇時會噴出一團發光的黏液，然後趁對方發愣時離開。' },

    /* --- 稀有 --- */
    { id: 'ab_anglerfish', name: '深淵鮟鱇', rarity: 'rare', shape: 'round', scale: 1.02, pattern: 'net', mult: 1.95, minLen: 20, maxLen: 60,
    ...
    { id: 'ab_gulper', name: '寬咽鰻', rarity: 'rare', shape: 'long', scale: 1.12, pattern: 'none', mult: 1.87, minLen: 60, maxLen: 140,
      special: ['glow'],
      colors: { body: '#1a1c22', back: '#0a0b0e', belly: '#2c3038', fin: '#111318', glow: '#7fa8ff' },
      desc: '嘴巴佔了身體的三分之一，可以吞下比自己還大的東西。尾端有一盞粉紅色的燈。' },
    { id: 'ab_chimaera', name: '幽光銀鮫', rarity: 'rare', shape: 'wide', scale: 1.04, pattern: 'speck', mult: 1.79, minLen: 50, maxLen: 110,
      special: ['spike'],
      colors: { body: '#8f9aa8', back: '#4a5460', belly: '#dde5ec', fin: '#6b7683', pattern: '#c0cdd8' },
      desc: '比鯊魚更古老的一支。背鰭前緣有根帶毒的硬棘，牠自己好像也不太會用。' },
    { id: 'ab_frilledshark', name: '皺鰓古鮫', rarity: 'rare', shape: 'long', scale: 1.16, pattern: 'band2', mult: 1.9, minLen: 80, maxLen: 180,
      colors: { body: '#4a4238', back: '#221e18', belly: '#8c8272', fin: '#342e26', pattern: '#6b6152' },
      desc: '八千萬年沒改過設計。游動方式不像鯊魚，比較像一條鰻。' },

    /* --- 史詩 --- */
    { id: 'ab_goblin', name: '哥布林鮫', rarity: 'epic', shape: 'wide', scale: 1.16, pattern: 'none', mult: 6.35, minLen: 150, maxLen: 330,
      special: ['spike', 'scar'],
      colors: { body: '#c89aa0', back: '#7a5460', belly: '#f0d8dc', fin: '#a87a84' },
      desc: '皮膚薄到看得見底下的血色。捕食時整組上下顎會往前彈出來，然後再縮回去。' },
    { id: 'ab_manta', name: '幽藍深海魟', rarity: 'epic', shape: 'ray', scale: 1.2, pattern: 'spot', mult: 6.54, minLen: 120, maxLen: 260,
      special: ['glow'],
    ...
    /* --- 傳說 --- */
    { id: 'ab_starcarrier', name: '載星者', rarity: 'legend', shape: 'flat', scale: 1.2, pattern: 'speck', mult: 26, minLen: 90, maxLen: 190,
      special: ['glow'],
      ...
      desc: '身上帶著一整片星圖的深海魚。' },
    { id: 'ab_endless', name: '無盡長鰻', rarity: 'legend', shape: 'slim', scale: 1.24, pattern: 'none', mult: 27, minLen: 250, maxLen: 500,
      special: ['glow'],
    ...
    /* --- 魚王 --- */
    { id: 'ab_king_nyx', name: '深淵之顎「尼克斯」', rarity: 'king', shape: 'abyss', scale: 1.34, pattern: 'net', mult: 133, minLen: 400, maxLen: 700,
  ...
  const WORLD_ROOT_FISH = [
    /* --- 雜物 --- */
    { id: 'wr_shield', name: '裂開的圓盾', rarity: 'junk', junkArt: 'shield', mult: 0.0338, minLen: 30, maxLen: 70, unit: 'cm', desc: '中央的凸飾還在，木板已經散了一半。有人在這裡打過架，或者只是把它丟了。' },
    { id: 'wr_can',    name: '苔痕符文石', rarity: 'junk', junkArt: 'wr_runestone', mult: 0.0284, minLen: 8, maxLen: 18, unit: 'cm', desc: '一面刻著斜杠與折線，另一面被樹根磨得圓滑發亮。' },
    { id: 'wr_root',   name: '根鬚護符',   rarity: 'junk', junkArt: 'wr_amulet', mult: 0.0308, minLen: 30, maxLen: 95, unit: 'cm', desc: '鹿角形吊墜被活根穿過，皮繩仍牢牢打著北方人的結。' },

    /* --- 普通（北大西洋的真實冷水魚，全部走銀白灰） --- */
    { id: 'wr_herring', name: '銀鯡', rarity: 'common', shape: 'torpedo', scale: .68, pattern: 'none', mult: 0.316, minLen: 15, maxLen: 32,
      colors: { body: '#b8c4cc', back: '#5f7180', belly: '#f4f8fa', fin: '#8fa0ac' },
      desc: '一群能有幾十萬條。極光亮起來的時候整片水面會跟著閃。' },
    { id: 'wr_capelin', name: '毛鱗魚', rarity: 'common', shape: 'torpedo', scale: .6, pattern: 'none', mult: 0.321, minLen: 8, maxLen: 18,
      colors: { body: '#a8b4b8', back: '#556468', belly: '#eef4f4', fin: '#7f8c90' },
      desc: '產卵之後就成片死在岸邊。這裡的每一種大魚都靠牠們過冬。' },
    { id: 'wr_lumpsucker', name: '圓鰭魚', rarity: 'common', shape: 'round', scale: .72, pattern: 'speck', mult: 0.328, minLen: 10, maxLen: 24,
      colors: { body: '#6f7f8a', back: '#3c4850', belly: '#c8d4d8', fin: '#54626b', pattern: '#94a4ac' },
      desc: '腹部有個吸盤，能整天吸在同一塊石頭上不動。' },
    { id: 'wr_plaice', name: '北海鰈', rarity: 'common', shape: 'flat', scale: .8, pattern: 'spot', mult: 0.335, minLen: 20, maxLen: 45,
      colors: { body: '#8a8470', back: '#4e4a3c', belly: '#eae6d8', fin: '#6b6658', pattern: '#c88f4a' },
      desc: '趴在砂上，只有那排橘點看得出牠在哪。' },
    { id: 'wr_whiting', name: '藍身鱈', rarity: 'common', shape: 'long', scale: .84, pattern: 'gradient', mult: 0.325, minLen: 22, maxLen: 48,
      colors: { body: '#7f8fa4', back: '#3f4d60', belly: '#dce4ec', fin: '#5f6e80' },
      desc: '白天沉在深處，天一暗就整群浮上來。這裡的天沒有真的亮過，所以牠們一直在上面。' },
    { id: 'wr_goby', name: '符文鰕虎', rarity: 'common', shape: 'round', scale: .64, pattern: 'net', mult: 0.33, minLen: 6, maxLen: 14,
      colors: { body: '#8a8478', back: '#4c4840', belly: '#dad4c4', fin: '#6a6558', pattern: '#c0b48f' },
      desc: '體側的花紋跟岸上石板的刻痕很像。當然只是巧合。' },

    /* --- 優良 --- */
    { id: 'wr_cod', name: '北洋鱈', rarity: 'good', shape: 'wide', scale: .94, pattern: 'speck', mult: 0.639, minLen: 40, maxLen: 90,
      colors: { body: '#8a8f78', back: '#4a4f3f', belly: '#e4e8d8', fin: '#686d58', pattern: '#b4b898' },
      desc: '一整個時代的人靠這種魚活下來，也為了牠打過仗。' },
    { id: 'wr_salmon', name: '銀腹鮭', rarity: 'good', shape: 'wide', scale: .92, pattern: 'spot', mult: 0.625, minLen: 35, maxLen: 80,
      colors: { body: '#a4aeb8', back: '#54606c', belly: '#f4f6f8', fin: '#7f8b96', pattern: '#3c4650' },
      desc: '牠們一路往上游，撞到瀑布也不轉彎。' },
    { id: 'wr_wolffish', name: '狼牙魚', rarity: 'good', shape: 'long', scale: .96, pattern: 'band2', mult: 0.652, minLen: 40, maxLen: 95,
      special: ['jaw'],
      colors: { body: '#5f5a6a', back: '#332f3c', belly: '#bab4c4', fin: '#474254', pattern: '#8a8498', tooth: '#f0ead8' },
      desc: '嘴裡的牙一年換一次，換牙那幾週牠什麼都不吃。' },
    { id: 'wr_turbot', name: '盾鱗鮃', rarity: 'good', shape: 'flat', scale: .88, pattern: 'net', mult: 0.635, minLen: 25, maxLen: 55,
      colors: { body: '#7a7264', back: '#443f36', belly: '#e0dacc', fin: '#5c5649', pattern: '#a89c84' },
      desc: '身上的骨質突起排得像一面小盾。拿起來手會被刮。' },
    { id: 'wr_spurdog', name: '角鯊', rarity: 'good', shape: 'long', scale: 1.0, pattern: 'none', mult: 0.66, minLen: 45, maxLen: 100,
      special: ['spike'],
      colors: { body: '#6a7480', back: '#3a424c', belly: '#c4ccd4', fin: '#505a66' },
      desc: '背鰭前那兩根刺帶毒。牠可以活一百年，慢到讓人以為牠不會死。' },

    /* --- 稀有 --- */
    { id: 'wr_halibut', name: '巨舌鮃', rarity: 'rare', shape: 'flat', scale: 1.08, pattern: 'spot', mult: 1.83, minLen: 60, maxLen: 170,
      colors: { body: '#5a5f5a', back: '#2e332f', belly: '#dfe4de', fin: '#42473f', pattern: '#8f9488' },
      desc: '拉上船之前最好先確認船比牠大。不是每次都是。' },
    { id: 'wr_ray', name: '雷紋電鰩', rarity: 'rare', shape: 'ray', scale: 1.04, pattern: 'net', mult: 1.88, minLen: 50, maxLen: 120,
      special: ['glow'],
      colors: { body: '#4a5570', back: '#242c40', belly: '#c4cee0', fin: '#343e54', pattern: '#8fd8ff', glow: '#7fc0ff' },
      desc: '摸到牠的人說那不像被電到，像被人用力推了一下。' },
    { id: 'wr_eel', name: '銀牙海鰻', rarity: 'rare', shape: 'slim', scale: 1.02, pattern: 'none', mult: 1.79, minLen: 50, maxLen: 110,
      colors: { body: '#4f5a5f', back: '#272e32', belly: '#c0c8c8', fin: '#3a4348' },
      desc: '從石縫裡出來的時候只看得到頭。後面有多長要等牠自己決定。' },
    { id: 'wr_lump', name: '盾牌魨', rarity: 'rare', shape: 'round', scale: 1.0, pattern: 'net', mult: 1.84, minLen: 30, maxLen: 70,
      special: ['spike'],
      colors: { body: '#7f6a5a', back: '#453a30', belly: '#ddcdb8', fin: '#5f5044', pattern: '#b09878' },
      desc: '整條魚外面裹著一層骨板，敲下去是硬的。牠不游，牠滾。' },

    /* --- 史詩（開始換成神話生物，配色吃極光） --- */
    { id: 'wr_nidhogg', name: '噬根幼龍', rarity: 'epic', shape: 'long', scale: 1.12, pattern: 'speck', mult: 6.39, minLen: 90, maxLen: 200,
      special: ['glow', 'jaw'],
    ...
    { id: 'wr_lyngbakr', name: '島鯨幼體', rarity: 'epic', shape: 'wide', scale: 1.14, pattern: 'none', mult: 6.52, minLen: 100, maxLen: 240,
      special: ['glow'],
      colors: { body: '#4a5566', back: '#222b38', belly: '#aab6c4', fin: '#333d4c', glow: '#8fa8e0' },
      desc: '成體背上會長出土和草，看起來就是一座島。上去生火的人再也沒回來——牠只是覺得燙。' },

    /* --- 傳說 --- */
    { id: 'wr_loki', name: '詭火鮭「洛基」', rarity: 'legend', shape: 'wide', scale: 1.2, pattern: 'scale', mult: 27.3, minLen: 70, maxLen: 150,
      special: ['glow'],
      ...
      desc: '尾巴上有一圈握過的痕跡。' },
    { id: 'wr_mead', name: '詩人蜜酒鰻', rarity: 'legend', shape: 'slim', scale: 1.2, pattern: 'speck', mult: 27.7, minLen: 90, maxLen: 190,
      special: ['glow'],
    ...
    /* --- 魚王 --- */
    { id: 'wr_king_jormungandr', name: '世界蛇「耶夢加得」', rarity: 'king', shape: 'serpent', scale: 1.3, pattern: 'scale', mult: 142, minLen: 500, maxLen: 900,
  ...
  const DUAT_FISH = [
    /* --- 雜物 --- */
    { id: 'du_shard',  name: '刻字陶片',     rarity: 'junk', junkArt: 'ostracon', mult: 0.0318, minLen: 6,  maxLen: 18, unit: 'cm', desc: '上面寫了字。看得懂的人早就不在了。' },
    { id: 'du_can',    name: '破口卡諾卜罐', rarity: 'junk', junkArt: 'du_canopic', mult: 0.0272, minLen: 10, maxLen: 24, unit: 'cm', desc: '胡狼頭罐蓋歪在一旁，罐腹裂口裡灌滿了細沙。' },
    { id: 'du_reed',   name: '褪色莎草卷',   rarity: 'junk', junkArt: 'du_papyrus', mult: 0.0294, minLen: 30, maxLen: 90, unit: 'cm', desc: '卷軸邊緣鬆散，墨線像被河水拖長的昆蟲腳印。' },

    /* --- 普通（尼羅河的真實魚種，全部走赭黃砂金） --- */
    { id: 'du_tilapia', name: '尼羅口孵魚', rarity: 'common', shape: 'flat', scale: .76, pattern: 'scale', mult: 0.303, minLen: 15, maxLen: 35,
      colors: { body: '#b4945a', back: '#6e5528', belly: '#f0e2b8', fin: '#8f7038', pattern: '#d8bc7a' },
      desc: '把卵含在嘴裡孵。壁畫上畫的就是牠，畫了三千年。' },
    { id: 'du_mormyrus', name: '象鼻長頜魚', rarity: 'common', shape: 'long', scale: .8, pattern: 'chevron', mult: 0.313, minLen: 20, maxLen: 45,
      colors: { body: '#8f7f6a', back: '#4e4436', belly: '#ded0b4', fin: '#6b5f4e' },
      desc: '用微弱的電流在濁水裡認路。牠的世界沒有形狀，只有訊號。' },
    { id: 'du_barbel',  name: '沙底鬚䰾', rarity: 'common', shape: 'normal', scale: .78, pattern: 'speck', mult: 0.297, minLen: 14, maxLen: 32,
      special: ['whisker'],
      colors: { body: '#a89060', back: '#605030', belly: '#e8dcbc', fin: '#84703f', pattern: '#c8b284' },
      desc: '整天用鬍鬚在沙裡撥。撥到什麼吃什麼。' },
    { id: 'du_elephant', name: '皺鰭象魚', rarity: 'common', shape: 'round', scale: .72, pattern: 'net', mult: 0.32, minLen: 10, maxLen: 26,
      colors: { body: '#9a8468', back: '#544636', belly: '#dccfb0', fin: '#75634c', pattern: '#bfa982' },
      desc: '游起來像一片被風吹著的葉子，但轉向比誰都快。' },
    { id: 'du_catlet',  name: '河床小鯰', rarity: 'common', shape: 'long', scale: .74, pattern: 'speck', mult: 0.303, minLen: 12, maxLen: 30,
      special: ['whisker'],
      colors: { body: '#7f6f58', back: '#453b2c', belly: '#cfc0a0', fin: '#5f5240', pattern: '#a89478' },
      desc: '白天埋在泥裡，晚上整條河床都是牠們。' },
    { id: 'du_puffer',  name: '尼羅河魨', rarity: 'common', shape: 'boxy', scale: .7, pattern: 'spot', mult: 0.309, minLen: 8, maxLen: 20,
      special: ['spike'],
      colors: { body: '#c8a860', back: '#7f6428', belly: '#f4ecc8', fin: '#a08840', pattern: '#4a3c20' },
      desc: '被抓起來會鼓成一顆球。鼓完就不肯消，只能等牠自己想通。' },

    /* --- 優良 --- */
    { id: 'du_perch',   name: '尼羅河鱸', rarity: 'good', shape: 'wide', scale: .96, pattern: 'saddle', mult: 0.612, minLen: 40, maxLen: 100,
      colors: { body: '#b0a888', back: '#5f5a44', belly: '#f2eed8', fin: '#8a8368' },
      desc: '這條河最大的普通魚。牠不需要傳說，牠光是重量就夠嚇人。' },
    { id: 'du_bichir',  name: '多鰭蘆魚', rarity: 'good', shape: 'slim', scale: .98, pattern: 'net', mult: 0.625, minLen: 35, maxLen: 80,
      special: ['spike'],
      colors: { body: '#7a7048', back: '#413b22', belly: '#cfc898', fin: '#5c5434', pattern: '#a89c68' },
      desc: '背上一排各自分開的小旗。這個設計比恐龍更早。' },
    { id: 'du_synodontis', name: '倒游鯰', rarity: 'good', shape: 'wide', scale: .9, pattern: 'spot', mult: 0.599, minLen: 20, maxLen: 48,
      special: ['whisker'],
      colors: { body: '#6a5f50', back: '#3a332a', belly: '#c8bca4', fin: '#4e4538', pattern: '#241f18' },
      desc: '習慣肚子朝上游。牠不覺得有問題，是你的方向反了。' },
    { id: 'du_tigerfish', name: '虎齒魚', rarity: 'good', shape: 'long', scale: 1.0, pattern: 'band2', mult: 0.638, minLen: 30, maxLen: 70,
      special: ['jaw'],
      colors: { body: '#c0b490', back: '#6e6444', belly: '#f4f0dc', fin: '#948a66', pattern: '#5f5638', tooth: '#fbf6e0' },
      desc: '牙齒閉起來的時候會露在唇外。漁夫不用手取鉤。' },
    { id: 'du_lates',   name: '金鱗巨鱸', rarity: 'good', shape: 'wide', scale: 1.02, pattern: 'scale', mult: 0.618, minLen: 45, maxLen: 110,
      colors: { body: '#c8b070', back: '#7f6a30', belly: '#f8f0cc', fin: '#a08c48', pattern: '#e4d09a' },
      desc: '出水的那一秒鱗片會反光，整條船的人都會安靜一下。' },

    /* --- 稀有 --- */
    { id: 'du_electric', name: '雷紋電鯰', rarity: 'rare', shape: 'wide', scale: 1.06, pattern: 'speck', mult: 1.83, minLen: 40, maxLen: 100,
      special: ['whisker', 'glow'],
      colors: { body: '#5f5a4a', back: '#332f26', belly: '#b8b09a', fin: '#464032', pattern: '#8fd8e8', glow: '#7fc8e0' },
      desc: '醫生曾經拿牠治頭痛。做法是叫病人把手放進水裡。' },
    { id: 'du_lapis',   name: '青金石鯉', rarity: 'rare', shape: 'round', scale: 1.0, pattern: 'scale', mult: 1.8, minLen: 30, maxLen: 70,
      special: ['glow'],
      colors: { body: '#3a5a9a', back: '#1c2c58', belly: '#c0d0ea', fin: '#2a4478', pattern: '#7f9fd8', glow: '#6f8fd0' },
      desc: '整條魚是青金石的顏色。那種藍在這條河的兩岸都挖不到。' },
    { id: 'du_ray',     name: '沙埋魟', rarity: 'rare', shape: 'ray', scale: 1.04, pattern: 'speck', mult: 1.85, minLen: 45, maxLen: 110,
      colors: { body: '#b49a68', back: '#6e5c34', belly: '#eee0bc', fin: '#8f7a48', pattern: '#7f6c40' },
      desc: '埋在沙裡只露出兩顆眼睛。踩到牠的人會記住一輩子。' },
    { id: 'du_moon',    name: '月影銀刀', rarity: 'rare', shape: 'flat', scale: 1.02, pattern: 'none', mult: 1.78, minLen: 35, maxLen: 85,
      special: ['glow'],
      colors: { body: '#dce4ea', back: '#8f9aa4', belly: '#ffffff', fin: '#b4c0ca', glow: '#e8f0f8' },
      desc: '薄到能透光。滿月的夜裡整群浮上來，遠看像水面裂了一道縫。' },

    /* --- 史詩（換成神話生物） --- */
    { id: 'du_ammit',   name: '吞心獸魚', rarity: 'epic', shape: 'wide', scale: 1.08, pattern: 'net', mult: 6.49, minLen: 90, maxLen: 200,
      special: ['glow', 'jaw'],
    ...
    { id: 'du_bennu',   name: '貝努鷺鰭魚', rarity: 'epic', shape: 'flat', scale: 1.1, pattern: 'band', mult: 6.58, minLen: 70, maxLen: 160,
      special: ['glow', 'finlet'],
      colors: { body: '#d88f4a', back: '#8a4a18', belly: '#f8dcac', fin: '#b06a28', pattern: '#ffd88f', glow: '#ff9f4f' },
      desc: '每隔很久燒起來一次，燒完從灰裡再游出來。沒有人算得準週期。' },

    /* --- 傳說 --- */
    { id: 'du_sobek',   name: '鱗甲河神「索貝克」', rarity: 'legend', shape: 'long', scale: 1.22, pattern: 'net', mult: 28.7, minLen: 120, maxLen: 260,
      ...
      desc: '同一位神，兩種祭品。' },
    { id: 'du_wadjet',  name: '聖眼金鱗「瓦吉特」', rarity: 'legend', shape: 'wide', scale: 1.18, pattern: 'spot', mult: 29, minLen: 100, maxLen: 220,
      special: ['glow', 'horn'],
    ...
    /* --- 魚王 --- */
    { id: 'du_king_osiris', name: '不死肺魚「歐西里斯」', rarity: 'king', shape: 'lungfish', scale: 1.3, pattern: 'speck', mult: 152, minLen: 300, maxLen: 620,
  ...
  const POND_FISH = [
    /* --- 雜物 --- */
    { id: 'gp_coins', name: '沉底的許願硬幣', rarity: 'junk', junkArt: 'coins', mult: 0.0717, minLen: 2, maxLen: 6, unit: 'cm', desc: '有人對著這座池子許過願。銅鏽把願望黏成了一塊。' },
    { id: 'gp_can',   name: '破掉的撈葉網', rarity: 'junk', junkArt: 'gp_skimmer', mult: 0.0477, minLen: 8, maxLen: 15, unit: 'cm', desc: '細網只剩半邊，短柄卡著一片剛好補不上的方磚碎角。' },
    { id: 'gp_duckweed', name: '裂紋飼料杯', rarity: 'junk', junkArt: 'gp_feedcup', mult: 0.0398, minLen: 10, maxLen: 30, unit: 'cm', desc: '杯底壓著幾顆沒被吃完的褐色飼料錠，邊緣有一圈硬水垢。' },

    /* --- 普通（自己混進來的野雜魚與飼料魚，一律灰褐土色） --- */
    { id: 'gp_feeder', name: '飼料金魚', rarity: 'common', shape: 'round', scale: .70, pattern: 'saddle', mult: 0.571, minLen: 4, maxLen: 12,
      colors: { body: '#a89a72', back: '#6a5f40', belly: '#ded4b4', fin: '#8a7c58' },
      desc: '一整袋幾十塊錢，本來是拿來餵別的魚的。這幾條活下來了。' },
    { id: 'gp_mosquito', name: '大肚魚', rarity: 'common', shape: 'torpedo', scale: .56, pattern: 'none', mult: 0.545, minLen: 2, maxLen: 6,
      colors: { body: '#9aa4a0', back: '#5a6460', belly: '#e4e8e4', fin: '#7c8684' },
      desc: '當初是為了吃孑孓才放的。現在牠們什麼都吃。' },
    { id: 'gp_bitterling', name: '石鮒', rarity: 'common', shape: 'flat', scale: .60, pattern: 'band', mult: 0.586, minLen: 3, maxLen: 9,
      colors: { body: '#8f9488', back: '#525648', belly: '#e2e4d8', fin: '#6f7468', pattern: '#6a7a72' },
      desc: '沒有人放過牠。大概是黏在水草上被一起搬進來的。' },
    { id: 'gp_wakin', name: '和金', rarity: 'common', shape: 'normal', scale: .72, pattern: 'gradient', mult: 0.618, minLen: 6, maxLen: 16,
      colors: { body: '#c88a4a', back: '#8a5620', belly: '#eed8ac', fin: '#a87038' },
      desc: '最不講究的一種金魚。廟會撈金魚撈到的就是牠，養得活的人不多。' },
    { id: 'gp_tilapia', name: '吳郭魚苗', rarity: 'common', shape: 'flat', scale: .70, pattern: 'stripe', mult: 0.598, minLen: 5, maxLen: 14,
      colors: { body: '#8a8470', back: '#4e4a3a', belly: '#dcd8c0', fin: '#6a6554', pattern: '#3f3c30' },
      desc: '不知道誰倒進來的。管理員每年撈一次，每年還是有。' },
    { id: 'gp_paradise', name: '蓋斑鬥魚', rarity: 'common', shape: 'flat', scale: .62, pattern: 'stripe', mult: 0.578, minLen: 3, maxLen: 8,
    ...
    { id: 'gp_hikoi', name: '緋鯉', rarity: 'good', shape: 'normal', scale: .86, pattern: 'none', mult: 1.01, minLen: 18, maxLen: 42,
      colors: { body: '#d4703a', back: '#8f3e14', belly: '#f6dcb0', fin: '#b45526' },
      desc: '整條都是橘紅色，沒有花紋。錦鯉裡最不值錢的那一種，也是最耐活的。' },
    { id: 'gp_ryukin', name: '琉金', rarity: 'good', shape: 'round', scale: .80, pattern: 'scale', mult: 0.992, minLen: 8, maxLen: 20,
      colors: { body: '#e0803a', back: '#9a4a12', belly: '#f8e0b0', fin: '#c06428', pattern: '#f0a860' },
      desc: '背高、尾長、游得慢。牠不是為了活下去被養成這樣的。' },
    { id: 'gp_oranda', name: '蘭壽', rarity: 'good', shape: 'round', scale: .78, pattern: 'speck', mult: 1.03, minLen: 8, maxLen: 22,
      colors: { body: '#e8e2d4', back: '#a89e8a', belly: '#ffffff', fin: '#cfc6b4', pattern: '#d0603a' },
      desc: '頭上那團肉瘤要養三年才長得出來。有人為了那三年一整年不出門。' },
    { id: 'gp_grasscarp', name: '白鯇', rarity: 'good', shape: 'wide', scale: .88, pattern: 'scale', mult: 0.979, minLen: 25, maxLen: 55,
      colors: { body: '#a0a688', back: '#5f6548', belly: '#e8ecd4', fin: '#7f856a', pattern: '#8a9070' },
      desc: '放牠進來是為了吃水草。牠吃完水草，然後開始吃睡蓮。' },
    { id: 'gp_pondcat', name: '池底鯰', rarity: 'good', shape: 'wide', scale: .84, pattern: 'speck', mult: 1.04, minLen: 22, maxLen: 50,
      special: ['whisker'],
      colors: { body: '#6f6858', back: '#3d382c', belly: '#cfc8b0', fin: '#565040', pattern: '#928a76' },
      desc: '白天貼在排水口底下。管理員知道牠在，也知道抓不到。' },

    /* --- 稀有（有名字有血統的品系，配色開始「乾淨」） --- */
    { id: 'gp_kohaku', name: '紅白錦鯉', rarity: 'rare', shape: 'normal', scale: 1.00, pattern: 'spot', mult: 2.39, minLen: 30, maxLen: 66,
      special: ['whisker'],
      colors: { body: '#f6f2ec', back: '#d0c8bc', belly: '#ffffff', fin: '#e4dcd0', pattern: '#d0392c' },
      desc: '紅白兩色，界線要利落。這一條的界線很利落。' },
    { id: 'gp_platinum', name: '白金鯉', rarity: 'rare', shape: 'torpedo', scale: 1.00, pattern: 'scale', mult: 2.34, minLen: 28, maxLen: 64,
      colors: { body: '#dfe4e8', back: '#a8b0b8', belly: '#ffffff', fin: '#c4ccd4', pattern: '#f4f8fa' },
      desc: '沒有任何花紋，整條是一片金屬白。花紋是加分，沒有花紋是另一種考試。' },
    { id: 'gp_ranchu', name: '獅頭蘭壽', rarity: 'rare', shape: 'round', scale: .96, pattern: 'scale', mult: 2.32, minLen: 10, maxLen: 26,
      colors: { body: '#e8603a', back: '#9a3410', belly: '#fbe8c8', fin: '#c04a20', pattern: '#ffa068' },
      desc: '沒有背鰭，只能靠尾巴一晃一晃地走。比賽是從上往下看的，所以牠一輩子只被人看過背。' },
    { id: 'gp_shubunkin', name: '朱文金', rarity: 'rare', shape: 'normal', scale: .98, pattern: 'spot', mult: 2.44, minLen: 14, maxLen: 34,
    ...
    /* --- 傳說 --- */
    { id: 'gp_ghost', name: '幽靈鯉', rarity: 'legend', shape: 'normal', scale: 1.16, pattern: 'scale', mult: 17.4, minLen: 60, maxLen: 120,
      special: ['glow', 'whisker'],
      ...
      desc: '半夜才浮上來的那一條。' },
    { id: 'gp_tancho', name: '丹頂', rarity: 'legend', shape: 'crest', scale: 1.14, pattern: 'none', mult: 17.5, minLen: 55, maxLen: 115,
      special: ['glow', 'whisker'],
    ...
    /* --- 魚王 --- */
    { id: 'gp_king_hyaku', name: '白鱗池主「百年」', rarity: 'king', shape: 'koi', scale: 1.28, pattern: 'scale', mult: 52.4, minLen: 110, maxLen: 200,
  ...
  const TIDAL_FISH = [
    /* --- 雜物 --- */
    { id: 'tf_shell',  name: '空的笠貝殼',   rarity: 'junk', junkArt: 'shell',  mult: 0.0493, minLen: 3,  maxLen: 9,  unit: 'cm', desc: '裡面的東西不在了。殼還牢牢吸在石頭上，被你連石頭一起撬起來。' },
    { id: 'tf_float',  name: '寄居蟹空殼',   rarity: 'junk', junkArt: 'tf_crabshell', mult: 0.0423, minLen: 12, maxLen: 30, unit: 'cm', desc: '殼口卡著斷掉的小蟹鉗，背上被潮池的石灰藻染成粉白。' },
    { id: 'tf_kelp',   name: '海蝕玻璃片',   rarity: 'junk', junkArt: 'tf_seaglass', mult: 0.0387, minLen: 20, maxLen: 70, unit: 'cm', desc: '原本的瓶身被浪磨成厚厚的海藍色圓角，摸起來像濕糖。' },

    /* --- 普通 --- */
    { id: 'tf_skipper', name: '彈塗魚', rarity: 'common', shape: 'long', scale: .62, pattern: 'speck', mult: 0.462, minLen: 5, maxLen: 14,
      colors: { body: '#7f7460', back: '#453e30', belly: '#cfc6ac', fin: '#5f5748', pattern: '#3a3428' },
      desc: '退潮以後牠不躲，牠出來。用兩隻胸鰭在泥上撐著走，看到人才慢慢挪開。' },
    { id: 'tf_blenny', name: '岩鳚', rarity: 'common', shape: 'long', scale: .66, pattern: 'band2', mult: 0.476, minLen: 6, maxLen: 16,
      colors: { body: '#6f7a5a', back: '#3c4430', belly: '#d8dcc0', fin: '#54604a', pattern: '#2e3524' },
      desc: '整條塞在石縫裡，只把頭伸出來。你走過去牠縮回去，你走遠牠又伸出來。' },
    { id: 'tf_stickle', name: '潮池刺魚', rarity: 'common', shape: 'flat', scale: .58, pattern: 'stripe', mult: 0.451, minLen: 3, maxLen: 8,
      special: ['spike'],
      colors: { body: '#9aa49c', back: '#565f58', belly: '#e8ece4', fin: '#7a847c', pattern: '#464f48' },
      desc: '背上三根硬刺。體型跟一節手指一樣，卻會為了一個水窪跟任何東西打架。' },
    { id: 'tf_shanny', name: '礁窟幼鮨', rarity: 'common', shape: 'round', scale: .64, pattern: 'spot', mult: 0.487, minLen: 4, maxLen: 11,
      colors: { body: '#8a7460', back: '#4e4034', belly: '#ded0bc', fin: '#6a5848', pattern: '#332a20' },
      desc: '長大以後會去外海。現在牠只知道這一個水窪有多大。' },
    { id: 'tf_sandeel', name: '玉筋魚', rarity: 'common', shape: 'slim', scale: .60, pattern: 'none', mult: 0.466, minLen: 5, maxLen: 15,
      colors: { body: '#c0c8c4', back: '#76807c', belly: '#f6faf8', fin: '#98a29e' },
      desc: '受驚就整條鑽進沙裡，一秒都不到。你要挖到牠，得比牠快。' },
    { id: 'tf_clingfish', name: '吸盤魚', rarity: 'common', shape: 'round', scale: .60, pattern: 'net', mult: 0.478, minLen: 3, maxLen: 8,
      colors: { body: '#a88a7a', back: '#5f4a3e', belly: '#e8d8cc', fin: '#846a5c', pattern: '#6a544a' },
      desc: '腹部整片是吸盤，浪打過來牠一動也不動。你要用鏟子才撬得下來。' },

    /* --- 優良 --- */
    { id: 'tf_rockfish', name: '礁石鮋', rarity: 'good', shape: 'flat', scale: .86, pattern: 'spot', mult: 0.861, minLen: 14, maxLen: 32,
      special: ['spike'],
      colors: { body: '#8a6a52', back: '#4e3a28', belly: '#e0cbb0', fin: '#6a5040', pattern: '#2e2218' },
      desc: '長得就是一塊石頭。每年都有人一腳踩上去，然後被抬走。' },
    { id: 'tf_mullet', name: '灘頭鯔', rarity: 'good', shape: 'torpedo', scale: .90, pattern: 'chevron', mult: 0.842, minLen: 22, maxLen: 48,
      colors: { body: '#a4b0b4', back: '#5a666a', belly: '#f2f6f8', fin: '#818d92' },
      desc: '漲潮第一批進來的就是牠們，退潮最後一批走的也是。' },
    { id: 'tf_eelpout', name: '潮溝鰻鳚', rarity: 'good', shape: 'long', scale: .92, pattern: 'speck', mult: 0.872, minLen: 25, maxLen: 55,
      colors: { body: '#5f6a5a', back: '#333a2e', belly: '#c4ccb8', fin: '#485144', pattern: '#8a9480' },
      desc: '離開水以後還能撐好幾個小時。牠不是在等你放手，牠是在等漲潮。' },
    { id: 'tf_flounder', name: '沙潛鰈', rarity: 'good', shape: 'flat', scale: .88, pattern: 'speck', mult: 0.828, minLen: 16, maxLen: 38,
      colors: { body: '#a89880', back: '#5f5442', belly: '#eee4d4', fin: '#847660', pattern: '#4a4034' },
      desc: '把自己抖進沙裡只要三下。抖完你就找不到牠了，就算你一直看著。' },
    { id: 'tf_wrasse', name: '潮池隆頭魚', rarity: 'good', shape: 'flat', scale: .84, pattern: 'band2', mult: 0.857, minLen: 12, maxLen: 28,
      colors: { body: '#4f8a7a', back: '#28504a', belly: '#e0e8d8', fin: '#c07a4a', pattern: '#7fc0a8' },
      desc: '天一黑就找個縫把自己塞進去，還會分泌一層黏膜把自己包起來睡。' },

    /* --- 稀有（潮池的螢光色開始出現） --- */
    { id: 'tf_anemonefish', name: '礁窟小丑魚', rarity: 'rare', shape: 'flat', scale: 1.00, pattern: 'band', mult: 2.17, minLen: 6, maxLen: 14,
      colors: { body: '#e8843a', back: '#a04a10', belly: '#f8dcb0', fin: '#2a2620', pattern: '#fbf6ec' },
      desc: '牠住的那顆海葵被留在退潮的水窪裡。海葵不會走，所以牠也不走。' },
    { id: 'tf_moray', name: '石縫裸胸鱔', rarity: 'rare', shape: 'long', scale: 1.06, pattern: 'net', mult: 2.13, minLen: 40, maxLen: 95,
      special: ['jaw'],
      colors: { body: '#6a6a4a', back: '#3a3a28', belly: '#cfc8a0', fin: '#50503a', pattern: '#c8bc84', tooth: '#f6f0dc' },
      desc: '整條在石頭底下，只有頭伸出來一開一合。那不是威嚇，牠只是在呼吸。' },
    { id: 'tf_parrot', name: '青嘴鸚哥', rarity: 'rare', shape: 'flat', scale: 1.02, pattern: 'scale', mult: 2.18, minLen: 20, maxLen: 45,
      colors: { body: '#3fa8a0', back: '#1f5f5c', belly: '#d8f0e8', fin: '#d86a8a', pattern: '#7fe0cc' },
      desc: '嘴是一塊硬骨板，專門啃珊瑚。這片礁灘的沙有一半是牠們拉出來的。' },
    { id: 'tf_pipefish', name: '潮池海龍', rarity: 'rare', shape: 'slim', scale: 1.04, pattern: 'stripe', mult: 2.12, minLen: 10, maxLen: 26,
    ...
    /* --- 傳說 --- */
    { id: 'tf_mandarin', name: '螢紋連鰭䲗', rarity: 'legend', shape: 'flat', scale: 1.14, pattern: 'net', mult: 22.2, minLen: 8, maxLen: 18,
      special: ['glow'],
      ...
      desc: '牠的藍只在活著的時候存在。' },
    { id: 'tf_stranded', name: '擱淺者', rarity: 'legend', shape: 'long', scale: 1.20, pattern: 'none', mult: 22.5, minLen: 90, maxLen: 190,
      special: ['glow'],
    ...
    /* --- 魚王 --- */
    { id: 'tf_king_kotaku', name: '灘王巨彈塗「涸澤」', rarity: 'king', shape: 'skipper', scale: 1.30, pattern: 'speck', mult: 94.6, minLen: 80, maxLen: 170,
  ...
  const FALL_FISH = [
    /* --- 雜物 --- */
    { id: 'fp_flask', name: '凹陷的水壺',   rarity: 'junk', junkArt: 'flask', mult: 0.0423, minLen: 15, maxLen: 26, unit: 'cm', desc: '從上面掉下來的。凹的那一面告訴你它撞過幾次岩壁。' },
    { id: 'fp_can',   name: '變形登山扣',   rarity: 'junk', junkArt: 'fp_carabiner', mult: 0.0358, minLen: 6, maxLen: 12, unit: 'cm', desc: '橘色陽極層被磨掉一半，卡榫張著，再也扣不回去。' },
    { id: 'fp_rope',  name: '防水地圖筒',   rarity: 'junk', junkArt: 'fp_mapcase', mult: 0.039, minLen: 40, maxLen: 120, unit: 'cm', desc: '透明筒壁撞出白痕，裡面的等高線圖已經暈成一片綠灰。' },

    /* --- 普通 --- */
    { id: 'fp_dace', name: '溪哥仔', rarity: 'common', shape: 'torpedo', scale: .68, pattern: 'stripe', mult: 0.413, minLen: 6, maxLen: 16,
      colors: { body: '#9fb0b4', back: '#546468', belly: '#f0f6f6', fin: '#7c8c90', pattern: '#5f7480' },
      desc: '整條溪最吵的一種。餌一落水牠們就衝過來，衝到你以為底下全是牠。' },
    { id: 'fp_hillstream', name: '爬岩鰍', rarity: 'common', shape: 'long', scale: .62, pattern: 'speck', mult: 0.423, minLen: 4, maxLen: 11,
      colors: { body: '#6a6250', back: '#3a352a', belly: '#c8c0a8', fin: '#514a3c', pattern: '#8f8874' },
      desc: '整片胸鰭腹鰭癒合成一個吸盤，吸在瀑布正下方那塊岩上。水從牠背上過，牠不動。' },
    { id: 'fp_whitefin', name: '白甲魚', rarity: 'common', shape: 'normal', scale: .72, pattern: 'saddle', mult: 0.41, minLen: 10, maxLen: 24,
      colors: { body: '#b0bcbc', back: '#667274', belly: '#f4f8f8', fin: '#8f9c9c' },
      desc: '嘴長在下面，橫著在石頭上刮藻。刮過的地方會留下一道一道白痕。' },
    { id: 'fp_bullhead', name: '潭底杜父魚', rarity: 'common', shape: 'round', scale: .68, pattern: 'speck', mult: 0.429, minLen: 5, maxLen: 13,
      colors: { body: '#5f5f52', back: '#333330', belly: '#c0c0b0', fin: '#464638', pattern: '#8a8a74' },
      desc: '趴在潭底的碎石堆裡，沒有魚鰾，所以牠沉得住。' },
    { id: 'fp_stone', name: '石賓', rarity: 'common', shape: 'normal', scale: .74, pattern: 'band2', mult: 0.415, minLen: 8, maxLen: 20,
      colors: { body: '#8a9088', back: '#4c5250', belly: '#e4e8e0', fin: '#6a7068', pattern: '#3a4040' },
      desc: '身上七八條淡淡的橫紋。放進水桶裡半小時，紋就淡到看不見了。' },
    { id: 'fp_shiner', name: '苦花', rarity: 'common', shape: 'flat', scale: .70, pattern: 'chevron', mult: 0.425, minLen: 8, maxLen: 22,
      colors: { body: '#c4ccc8', back: '#7a8480', belly: '#f8fafa', fin: '#a0aaa6' },
      desc: '翻身刮藻的那一瞬間側面會反光。整潭一起翻的時候，水底像有人在打閃。' },

    /* --- 優良 --- */
    { id: 'fp_squaliobarbus', name: '赤眼鱒', rarity: 'good', shape: 'normal', scale: .88, pattern: 'scale', mult: 0.772, minLen: 20, maxLen: 46,
      colors: { body: '#a8b0a4', back: '#5c6458', belly: '#eef2ea', fin: '#848c80', pattern: '#c85a3a' },
      desc: '眼睛上緣一抹紅。除此之外沒有任何地方引人注意，牠似乎也知道。' },
    { id: 'fp_hemibarbus', name: '花鮕', rarity: 'good', shape: 'wide', scale: .90, pattern: 'spot', mult: 0.783, minLen: 22, maxLen: 50,
      special: ['whisker'],
      colors: { body: '#9a9078', back: '#544e3c', belly: '#e8e2cc', fin: '#78705c', pattern: '#3a3428' },
      desc: '在急流跟緩流的交界處守著。水一慢，牠就把頭轉過去。' },
    { id: 'fp_torrent', name: '激流吸盤鰍', rarity: 'good', shape: 'long', scale: .84, pattern: 'net', mult: 0.765, minLen: 12, maxLen: 28,
      colors: { body: '#6f6a5f', back: '#3c3830', belly: '#cfc8b8', fin: '#565048', pattern: '#a09680' },
      desc: '水流越急牠貼得越牢。把牠從石頭上撕下來，石頭上會留下一個乾淨的圓。' },
    { id: 'fp_climber', name: '禿頭鯊', rarity: 'good', shape: 'long', scale: .86, pattern: 'speck', mult: 0.793, minLen: 10, maxLen: 24,
    ...
    { id: 'fp_anguilla', name: '潭底鱸鰻', rarity: 'good', shape: 'slim', scale: .94, pattern: 'speck', mult: 0.775, minLen: 40, maxLen: 90,
      colors: { body: '#5a5f4a', back: '#2e332a', belly: '#c0c4a8', fin: '#42473a', pattern: '#8a8f70' },
      desc: '白天塞在瀑布後面的岩洞裡。那個洞有多深，沒有人量過，因為沒有人想把手伸進去。' },

    /* --- 稀有（婚姻色出現） --- */
    { id: 'fp_landlocked', name: '陸封櫻花鉤吻鮭', rarity: 'rare', shape: 'wide', scale: 1.02, pattern: 'spot', mult: 2.04, minLen: 25, maxLen: 55,
      colors: { body: '#8fa0a8', back: '#4e5c64', belly: '#f2eee2', fin: '#6e7e86', pattern: '#3a4650' },
      desc: '牠的祖先本來要回海裡。冰河退了，路斷了，牠們就留在這一段溪裡，留了一萬年。' },
    { id: 'fp_mahseer', name: '金鱗結魚', rarity: 'rare', shape: 'wide', scale: 1.04, pattern: 'scale', mult: 2.02, minLen: 35, maxLen: 80,
      special: ['whisker'],
      colors: { body: '#c8ac60', back: '#7f6828', belly: '#f6ecc0', fin: '#a08c40', pattern: '#e0c888' },
      desc: '鱗片有指甲那麼大，一片一片數得出來。上鉤之後牠會直接往瀑布衝，很多人的線就是這樣斷的。' },
    { id: 'fp_snakehead', name: '潭中鱧', rarity: 'rare', shape: 'long', scale: 1.02, pattern: 'band2', mult: 2.04, minLen: 30, maxLen: 70,
      special: ['jaw'],
    ...
    { id: 'fp_bigeye', name: '深潭大眼鱒', rarity: 'rare', shape: 'normal', scale: 1.00, pattern: 'speck', mult: 2.03, minLen: 28, maxLen: 62,
    ...
    /* --- 史詩 --- */
    { id: 'fp_thunder', name: '雷紋巨鱒', rarity: 'epic', shape: 'wide', scale: 1.10, pattern: 'band2', mult: 6.56, minLen: 70, maxLen: 150,
      special: ['glow'],
    ...
    { id: 'fp_veil', name: '白沫幻鰭', rarity: 'epic', shape: 'flat', scale: 1.08, pattern: 'none', mult: 6.5, minLen: 40, maxLen: 90,
      special: ['glow'],
      colors: { body: '#eef4f4', back: '#b4c0c0', belly: '#ffffff', fin: '#d8e4e4', glow: '#f0fafa' },
      desc: '只在落水點那一片翻湧的白沫裡出現。一游出泡沫區就看不見了——不是躲起來，是牠本來就跟泡沫一個顏色。' },

    /* --- 傳說 --- */
    { id: 'fp_curtain', name: '水簾白魚', rarity: 'legend', shape: 'flat', scale: 1.18, pattern: 'none', mult: 23.9, minLen: 50, maxLen: 110,
      special: ['glow'],
      ...
      desc: '住在瀑布後面那一段。' },
    { id: 'fp_roar', name: '轟聲巨鮠', rarity: 'legend', shape: 'long', scale: 1.20, pattern: 'speck', mult: 24.1, minLen: 100, maxLen: 220,
      special: ['glow', 'whisker'],
    ...
    /* --- 魚王 --- */
    { id: 'fp_king_gyakuryu', name: '躍瀑巨鮭「逆流」', rarity: 'king', shape: 'leaper', scale: 1.30, pattern: 'band', mult: 110, minLen: 150, maxLen: 290,
  ...
  const CALDERA_FISH = [
    /* --- 雜物 --- */
    { id: 'cd_brimstone', name: '硫磺結晶塊', rarity: 'junk', junkArt: 'brimstone', mult: 0.0376, minLen: 5,  maxLen: 18, unit: 'cm', desc: '拿在手上會沾一層黃粉，洗三次才洗得掉，味道洗不掉。' },
    { id: 'cd_can',       name: '黑曜石碎片',   rarity: 'junk', junkArt: 'cd_obsidian', mult: 0.033, minLen: 6, maxLen: 14, unit: 'cm', desc: '邊緣利得像玻璃，黑面映出硫煙時會有一瞬間的金綠反光。' },
    { id: 'cd_algae',     name: '礦痕護目鏡',   rarity: 'junk', junkArt: 'cd_goggles', mult: 0.0351, minLen: 15, maxLen: 50, unit: 'cm', desc: '兩片鏡片被黃白礦物封住，只剩鼻樑中間還露著焦黑橡膠。' },

    /* --- 普通（真的活在鹼湖與溫泉裡的魚種） --- */
    { id: 'cd_alcolapia', name: '鹼湖麗魚', rarity: 'common', shape: 'flat', scale: .74, pattern: 'band', mult: 0.371, minLen: 5, maxLen: 12,
      colors: { body: '#a89858', back: '#5f5424', belly: '#e8dcae', fin: '#84763c', pattern: '#4a4220' },
      desc: '這片水的 pH 值接近漂白水。牠不只活著，牠還在這裡產卵。' },
    { id: 'cd_pupfish', name: '溫泉鱂', rarity: 'common', shape: 'torpedo', scale: .58, pattern: 'speck', mult: 0.379, minLen: 2, maxLen: 6,
      colors: { body: '#7f8f9a', back: '#465058', belly: '#dfe8ec', fin: '#64727c', pattern: '#8fc0c8' },
      desc: '全世界只有這一池有。整個物種加起來不到兩百條，而牠們從來沒想過要離開。' },
    { id: 'cd_hottilapia', name: '湯口吳郭', rarity: 'common', shape: 'flat', scale: .78, pattern: 'scale', mult: 0.367, minLen: 10, maxLen: 26,
      colors: { body: '#8f8468', back: '#4e4634', belly: '#dcd4b8', fin: '#6c634c', pattern: '#b0a684' },
      desc: '別的地方牠只是普通的吳郭魚。在這裡牠是唯一撐得住四十度水溫的大型魚。' },
    { id: 'cd_mudloach', name: '泥火山鰍', rarity: 'common', shape: 'long', scale: .70, pattern: 'speck', mult: 0.382, minLen: 6, maxLen: 18,
      special: ['whisker'],
      colors: { body: '#6a5f4a', back: '#3a3428', belly: '#c8c0a4', fin: '#514a38', pattern: '#948a6c' },
      desc: '住在會冒泡的那一區。泡是硫化氫，牠聞不到，或者牠不在意。' },
    { id: 'cd_gudgeon', name: '硫底鰕虎', rarity: 'common', shape: 'round', scale: .66, pattern: 'spot', mult: 0.374, minLen: 3, maxLen: 9,
      colors: { body: '#a89a5a', back: '#5f5624', belly: '#e8e0b0', fin: '#847838', pattern: '#3a3418' },
      desc: '趴在黃色的結晶上，體色跟結晶一模一樣。撈起來以後才發現手上多了一條。' },
    { id: 'cd_killifish', name: '蒸氣鱂', rarity: 'common', shape: 'long', scale: .60, pattern: 'stripe', mult: 0.376, minLen: 3, maxLen: 8,
      colors: { body: '#b0bcb8', back: '#647070', belly: '#f2f8f6', fin: '#8c9894', pattern: '#7f9490' },
      desc: '整群貼在水面下一公分處，蒸氣從牠們背上飄過去。那是這座湖最涼的一層。' },

    /* --- 優良 --- */
    { id: 'cd_hotcarp', name: '湯鯉', rarity: 'good', shape: 'normal', scale: .88, pattern: 'scale', mult: 0.709, minLen: 22, maxLen: 50,
      special: ['whisker'],
      colors: { body: '#b09858', back: '#655324', belly: '#eee0b0', fin: '#8a7640', pattern: '#c8b078' },
      desc: '在這種水溫裡牠長得比別處快一倍，也老得比別處快一倍。' },
    { id: 'cd_venteel', name: '熱泉鰻', rarity: 'good', shape: 'slim', scale: .94, pattern: 'none', mult: 0.724, minLen: 35, maxLen: 80,
      colors: { body: '#5a4f48', back: '#2e2824', belly: '#bcb0a4', fin: '#443c36' },
      desc: '整條纏在噴氣孔的邊上。那裡的水燙到手伸不進去，牠待了一整個晚上。' },
    { id: 'cd_basalt', name: '玄武岩杜父魚', rarity: 'good', shape: 'round', scale: .80, pattern: 'net', mult: 0.703, minLen: 10, maxLen: 24,
      special: ['spike'],
      colors: { body: '#4a4650', back: '#26242c', belly: '#aaa4b0', fin: '#363340', pattern: '#6f6a78' },
      desc: '黑得跟湖底的石頭一樣，連表面那些六角形的裂紋都學到了。' },
    { id: 'cd_barb', name: '硫紋䰾', rarity: 'good', shape: 'normal', scale: .86, pattern: 'band2', mult: 0.717, minLen: 15, maxLen: 36,
      colors: { body: '#c8b060', back: '#7f6a24', belly: '#f4ecc0', fin: '#a08c3c', pattern: '#4e4218' },
      desc: '身上兩道深黃的橫帶，位置跟岸邊結晶階地的層次剛好對得上。' },
    { id: 'cd_hotcat', name: '湯底鯰', rarity: 'good', shape: 'wide', scale: .88, pattern: 'speck', mult: 0.72, minLen: 25, maxLen: 55,
      special: ['whisker'],
      colors: { body: '#6f6350', back: '#3d3628', belly: '#cfc6a8', fin: '#565040', pattern: '#948a70' },
      desc: '湖底最深那一層水是冷的。牠白天待在那裡，晚上才上來，上來的時候身上會冒煙。' },

    /* --- 稀有（暖光開始出現） --- */
    { id: 'cd_ember', name: '餘燼緋鱗', rarity: 'rare', shape: 'wide', scale: 1.02, pattern: 'speck', mult: 1.96, minLen: 30, maxLen: 70,
      special: ['glow'],
    ...
    { id: 'cd_malachite', name: '孔雀石鯉', rarity: 'rare', shape: 'normal', scale: 1.00, pattern: 'scale', mult: 1.94, minLen: 30, maxLen: 68,
      special: ['glow'],
      colors: { body: '#3f9a7a', back: '#1c5040', belly: '#c8ecd8', fin: '#2c7058', pattern: '#7fe0b0', glow: '#5fd8a0' },
      desc: '那個綠是銅的顏色。湖底的礦脈裡有銅，而牠吃湖底的東西吃了一輩子。' },
    { id: 'cd_obsidian', name: '黑曜刀魚', rarity: 'rare', shape: 'slim', scale: 1.04, pattern: 'none', mult: 1.95, minLen: 35, maxLen: 80,
      colors: { body: '#2a2630', back: '#131118', belly: '#6a6478', fin: '#1e1c24' },
      desc: '薄、黑、邊緣鋒利。從側面看幾乎看不見牠，從正面看只有一條線。' },
    { id: 'cd_vent', name: '噴氣孔盲魚', rarity: 'rare', shape: 'long', scale: 1.00, pattern: 'none', mult: 1.94, minLen: 20, maxLen: 46,
      special: ['glow'],
      colors: { body: '#e0d4c4', back: '#a89a86', belly: '#f8f2e8', fin: '#c4b8a4', glow: '#ffd8a8' },
      desc: '沒有眼睛，皮膚是透明的偏白。牠靠側線感覺水溫的變化，往燙的那一邊走。' },

    /* --- 史詩 --- */
    { id: 'cd_magma', name: '熔岩紋巨鯙', rarity: 'epic', shape: 'long', scale: 1.10, pattern: 'net', mult: 6.56, minLen: 90, maxLen: 200,
      special: ['glow', 'jaw'],
    ...
    { id: 'cd_geyser', name: '間歇泉躍魚', rarity: 'epic', shape: 'wide', scale: 1.08, pattern: 'band', mult: 6.52, minLen: 60, maxLen: 140,
      special: ['glow'],
    ...
    /* --- 傳說 --- */
    { id: 'cd_pele', name: '佩蕾之髮', rarity: 'legend', shape: 'long', scale: 1.20, pattern: 'speck', mult: 25.8, minLen: 80, maxLen: 180,
      special: ['glow', 'filaments'],
      ...
      desc: '牠身上那幾條會割手。' },
    { id: 'cd_namaka', name: '娜瑪卡', rarity: 'legend', shape: 'wide', scale: 1.18, pattern: 'scale', mult: 26.1, minLen: 90, maxLen: 200,
      special: ['glow'],
    ...
    /* --- 魚王 --- */
    { id: 'cd_king_yobi', name: '不滅腔棘魚「餘火」', rarity: 'king', shape: 'coelacanth', scale: 1.30, pattern: 'net', mult: 127, minLen: 190, maxLen: 360,
  ...
  const RAPIDS_FISH = [
    /* --- 雜物 --- */
    { id: 'rp_driftwood', name: '磨圓的漂流木', rarity: 'junk', junkArt: 'driftwood', mult: 0.0667, minLen: 25, maxLen: 60, unit: 'cm', desc: '被水滾了不知道幾年，稜角全沒了。斷面的年輪還數得出來，二十七圈。' },
    { id: 'rp_can',  name: '彎折岩釘',       rarity: 'junk', junkArt: 'rp_piton', mult: 0.0485, minLen: 5, maxLen: 11, unit: 'cm', desc: '金屬頭被急流拋的卵石敲扁，裂縫裡長出細細的綠苔。' },
    { id: 'rp_line', name: '破損蜉蝣盒',     rarity: 'junk', junkArt: 'rp_mayflycase', mult: 0.0364, minLen: 20, maxLen: 80, unit: 'cm', desc: '木盒蓋掀開一角，羽毛假餌全被水沖成貼在一起的褐色團。' },

    /* --- 普通 --- */
    { id: 'rp_horsemouth', name: '馬口魚', rarity: 'common', shape: 'long', scale: .70, pattern: 'stripe', mult: 0.556, minLen: 7, maxLen: 18,
      colors: { body: '#9aa8a8', back: '#54615f', belly: '#f0f4f2', fin: '#778584', pattern: '#5f7a84' },
      desc: '牠佔的是水舌正下方那個坑。餌一落水牠就從坑裡衝上來，衝到你來不及看清楚是什麼咬的。' },
    { id: 'rp_goby', name: '吻鰕虎', rarity: 'common', shape: 'long', scale: .58, pattern: 'speck', mult: 0.545, minLen: 4, maxLen: 11,
      colors: { body: '#7f7460', back: '#463f31', belly: '#cfc8b0', fin: '#5f5849', pattern: '#37301f' },
      desc: '牠佔的是石縫，整條塞在裡面只露一顆頭。同一條縫每年都有一隻，不見得是同一隻。' },
    { id: 'rp_stoneloach', name: '纓口鰍', rarity: 'common', shape: 'long', scale: .60, pattern: 'net', mult: 0.561, minLen: 4, maxLen: 10,
      colors: { body: '#6f6a54', back: '#3c382a', belly: '#c8c2a4', fin: '#524d3d', pattern: '#8f8a6f' },
      desc: '牠佔的是石頭的迎水面——水最急的那一面。所有魚都躲到石頭後面，只有牠反過來。' },
    { id: 'rp_barb', name: '條紋鬚䰾', rarity: 'common', shape: 'normal', scale: .72, pattern: 'stripe', mult: 0.55, minLen: 8, maxLen: 20,
    ...
    { id: 'rp_bleak', name: '溪鰷', rarity: 'common', shape: 'torpedo', scale: .64, pattern: 'gradient', mult: 0.541, minLen: 5, maxLen: 14,
      colors: { body: '#bcc8c8', back: '#71807f', belly: '#f8fafa', fin: '#98a4a4' },
      desc: '牠佔的是兩道水舌中間的分水處。那裡水最淺、最不值錢，所以沒有人跟牠搶。' },
    { id: 'rp_sculpin', name: '寬頭鮈', rarity: 'common', shape: 'round', scale: .66, pattern: 'speck', mult: 0.567, minLen: 5, maxLen: 13,
      colors: { body: '#5f5c50', back: '#33322c', belly: '#bfbcaa', fin: '#464438', pattern: '#8a8674' },
      desc: '牠佔的是石頭底下，一整天都不出來。翻石頭的人常常先看到牠的影子跑掉，才知道底下有東西。' },

    /* --- 優良 --- */
    { id: 'rp_yamame', name: '山女鱒', rarity: 'good', shape: 'normal', scale: .86, pattern: 'spot', mult: 0.974, minLen: 16, maxLen: 34,
    ...
    { id: 'rp_iwana', name: '岩魚', rarity: 'good', shape: 'wide', scale: .88, pattern: 'spot', mult: 0.983, minLen: 20, maxLen: 42,
      colors: { body: '#77837f', back: '#3f4a48', belly: '#eae4d4', fin: '#5c6664', pattern: '#d8c8a0' },
      desc: '牠佔的是最上游那一段。再往上就沒有魚了——不是水不好，是水太少，撐不起一條這麼大的。' },
    { id: 'rp_ayu', name: '香魚', rarity: 'good', shape: 'torpedo', scale: .84, pattern: 'chevron', mult: 0.964, minLen: 14, maxLen: 30,
      colors: { body: '#b4c0b8', back: '#697470', belly: '#f6f8f4', fin: '#8f9a94' },
      desc: '牠佔的不是一個位置，是一塊石頭上的藻。牠繞著那塊石頭巡，別的魚靠近就用身體撞。' },
    { id: 'rp_chub', name: '圓吻鮠', rarity: 'good', shape: 'wide', scale: .86, pattern: 'speck', mult: 0.953, minLen: 18, maxLen: 40,
      special: ['whisker'],
      colors: { body: '#8f8874', back: '#4e4a3c', belly: '#e4dec8', fin: '#6d6857', pattern: '#38342a' },
      desc: '牠佔的是深槽的底部。那裡水是慢的、暗的，牠靠四根鬚在石頭之間摸，不太需要眼睛。' },
    { id: 'rp_spinedloach', name: '花鰍', rarity: 'good', shape: 'long', scale: .80, pattern: 'speck', mult: 0.969, minLen: 10, maxLen: 22,
      colors: { body: '#a89a7a', back: '#5f5544', belly: '#ece4cc', fin: '#847a5f', pattern: '#463d2a' },
      desc: '牠佔的是沙礫的縫。整條鑽進去只露兩顆眼睛，你把手伸過去牠往更深的地方鑽。' },

    /* --- 稀有（虹彩出現） --- */
    { id: 'rp_rainbow', name: '虹彩鱲', rarity: 'rare', shape: 'normal', scale: 1.00, pattern: 'scale', mult: 2.31, minLen: 20, maxLen: 44,
      colors: { body: '#8fa8b0', back: '#4a6068', belly: '#f4f0e4', fin: '#c86a8f', pattern: '#7fd8c0' },
      desc: '側線那一道會隨著角度從青轉紫再轉金。在白水裡那是唯一看得見的東西——所以牠不躲，牠閃。' },
    { id: 'rp_masu', name: '降海型櫻鱒', rarity: 'rare', shape: 'wide', scale: 1.02, pattern: 'spot', mult: 2.29, minLen: 30, maxLen: 68,
      colors: { body: '#a8b4b8', back: '#5c686c', belly: '#f6f2e8', fin: '#84908f', pattern: '#c8506a' },
      desc: '牠佔的是最上面那個潭，而且只佔一季。秋天一到牠就走了，走的時候整條溪空掉一半。' },
    { id: 'rp_goldenbarb', name: '金線䰾', rarity: 'rare', shape: 'normal', scale: 1.00, pattern: 'stripe', mult: 2.31, minLen: 18, maxLen: 40,
      colors: { body: '#c0b478', back: '#7a6f38', belly: '#f6f0c8', fin: '#9a8f50', pattern: '#e8d88f' },
      desc: '身側一條金線從鰓一路拉到尾。水一急那條線會斷成一節一節，像有人在水裡打摩斯電碼。' },
    { id: 'rp_torrentcat', name: '石紋鮡', rarity: 'rare', shape: 'long', scale: 1.02, pattern: 'net', mult: 2.29, minLen: 15, maxLen: 34,
      special: ['whisker'],
    ...
    /* --- 傳說 --- */
    { id: 'rp_amber', name: '琥珀岩魚', rarity: 'legend', shape: 'wide', scale: 1.16, pattern: 'spot', mult: 18.3, minLen: 60, maxLen: 125,
      special: ['glow'],
      ...
      desc: '懸在照不到太陽的那個潭的中層。' },
    { id: 'rp_thread', name: '一線鱲', rarity: 'legend', shape: 'slim', scale: 1.18, pattern: 'stripe', mult: 18.1, minLen: 35, maxLen: 75,
      special: ['glow'],
    ...
    /* --- 魚王 --- */
    { id: 'rp_king_fuseki', name: '石紋巨鰍「伏石」', rarity: 'king', shape: 'clinger', scale: 1.28, pattern: 'net', mult: 60.1, minLen: 110, maxLen: 200,
  ...
  const CORAL_FISH = [
    /* --- 雜物 --- */
    { id: 'cr_coralfrag', name: '白化的珊瑚枝', rarity: 'junk', junkArt: 'coralfrag', mult: 0.0555, minLen: 8,  maxLen: 22, unit: 'cm', desc: '折斷的鹿角枝，白得像骨頭。活著的時候它是紫色的。' },
    { id: 'cr_can',       name: '珊瑚附著鉛墜', rarity: 'junk', junkArt: 'cr_weight', mult: 0.039, minLen: 6, maxLen: 12, unit: 'cm', desc: '鉛墜上長出三顆亮紫色小珊瑚，反而比原來的釣組顯眼。' },
    { id: 'cr_net',       name: '遺失潛水面鏡', rarity: 'junk', junkArt: 'cr_mask', mult: 0.0456, minLen: 30, maxLen: 90, unit: 'cm', desc: '透明鏡面從內側蒙上一層白霧，矽膠帶被小魚啃出細齒印。' },

    /* --- 普通 --- */
    { id: 'cr_damsel', name: '藍雀鯛', rarity: 'common', shape: 'flat', scale: .62, pattern: 'chevron', mult: 0.513, minLen: 4, maxLen: 10,
      colors: { body: '#2f6ae0', back: '#16357f', belly: '#7fa8ff', fin: '#4a86f0' },
      desc: '那身電光藍是給同種看的，不是給你看的——牠們用顏色的深淺互相報告誰佔了哪一叢珊瑚。' },
    { id: 'cr_sergeant', name: '條紋豆娘魚', rarity: 'common', shape: 'flat', scale: .66, pattern: 'stripe', mult: 0.504, minLen: 6, maxLen: 15,
      colors: { body: '#e8d05f', back: '#a08a18', belly: '#f8f0c8', fin: '#c8b040', pattern: '#20242a' },
      desc: '五條黑帶不是裝飾，是把身體的輪廓切開。掠食者看到的是五塊互不相連的東西，不是一條魚。' },
    { id: 'cr_cardinal', name: '絲鰭天竺鯛', rarity: 'common', shape: 'flat', scale: .60, pattern: 'band', mult: 0.499, minLen: 4, maxLen: 9,
      colors: { body: '#d84a4a', back: '#8f2020', belly: '#f8c8b0', fin: '#e87a6a', pattern: '#2a1a20' },
      desc: '紅色在水下十公尺就變成灰的——所以在礁洞裡牠等於隱形。牠只在洞裡待著，白天不出來。' },
    { id: 'cr_wrassejuv', name: '幼隆頭魚', rarity: 'common', shape: 'long', scale: .64, pattern: 'stripe', mult: 0.518, minLen: 5, maxLen: 13,
      colors: { body: '#3fc0a8', back: '#1f7a70', belly: '#c8f4ea', fin: '#e8a83a', pattern: '#f0f4f0' },
      desc: '身上那條白帶是招牌：掛著這個顏色的魚會幫別人清寄生蟲，所以大魚不吃牠，還會排隊。' },
    { id: 'cr_gobyshrimp', name: '共生鰕虎', rarity: 'common', shape: 'long', scale: .58, pattern: 'spot', mult: 0.494, minLen: 3, maxLen: 8,
    ...
    { id: 'cr_surgeonjuv', name: '幼刺尾鯛', rarity: 'common', shape: 'flat', scale: .68, pattern: 'band2', mult: 0.525, minLen: 5, maxLen: 12,
      colors: { body: '#f0a83a', back: '#a86a10', belly: '#f8dca8', fin: '#2f7fc8', pattern: '#20242a' },
      desc: '尾柄兩側各有一片會彈出來的刀。那片刀是藍的，藍得跟身體完全不搭——因為它本來就該被看見。' },

    /* --- 優良 --- */
    { id: 'cr_snapper', name: '藍紋笛鯛', rarity: 'good', shape: 'wide', scale: .88, pattern: 'stripe', mult: 0.911, minLen: 18, maxLen: 40,
    ...
    { id: 'cr_butterfly', name: '四線蝶魚', rarity: 'good', shape: 'flat', scale: .84, pattern: 'band', mult: 0.899, minLen: 10, maxLen: 22,
      colors: { body: '#f8e070', back: '#b09818', belly: '#fbf4c8', fin: '#e8c840', pattern: '#20242a' },
      desc: '眼睛藏在一道黑帶裡，尾巴那邊卻畫了一顆假眼。你要咬的那一頭，牠會往反方向跑。' },
    { id: 'cr_angel', name: '皇后神仙魚', rarity: 'good', shape: 'flat', scale: .88, pattern: 'band2', mult: 0.918, minLen: 15, maxLen: 34,
      colors: { body: '#2f6fd8', back: '#183a7f', belly: '#a8d8f8', fin: '#f0d060', pattern: '#f8e8a0' },
      desc: '幼魚跟成魚的花色完全不一樣，不一樣到早年被當成兩個物種。換色的那幾個月牠會被兩邊都當成外人。' },
    { id: 'cr_trigger', name: '花斑擬鱗魨', rarity: 'good', shape: 'round', scale: .86, pattern: 'net', mult: 0.892, minLen: 14, maxLen: 32,
      colors: { body: '#e8f0e8', back: '#98a498', belly: '#ffffff', fin: '#f0a03a', pattern: '#20242a' },
      desc: '那身斑點是給你記住的：牠護巢的時候會追人，而且會追到你離開牠那一整塊沙地為止。' },
    { id: 'cr_moorish', name: '鐮魚', rarity: 'good', shape: 'flat', scale: .86, pattern: 'stripe', mult: 0.907, minLen: 12, maxLen: 26,
    ...
    /* --- 稀有（開始改用輪廓分階） --- */
    { id: 'cr_lionfish', name: '翱翔蓑鮋', rarity: 'rare', shape: 'flat', scale: 1.02, pattern: 'stripe', mult: 2.23, minLen: 15, maxLen: 38,
      special: ['spike'],
      colors: { body: '#e8dcd0', back: '#9a8070', belly: '#fbf4ec', fin: '#c84a3a', pattern: '#7a2418' },
      desc: '牠不躲也不快。那身斑馬紋加上十八根散開的鰭棘是一句話：我有毒，你自己看著辦。' },
    { id: 'cr_ribbon', name: '藍帶裸胸鱔', rarity: 'rare', shape: 'long', scale: 1.06, pattern: 'ocellus', mult: 2.2, minLen: 45, maxLen: 100,
      special: ['jaw'],
    ...
    { id: 'cr_bluespotray', name: '藍點魟', rarity: 'rare', shape: 'ray', scale: 1.04, pattern: 'spot', mult: 2.19, minLen: 25, maxLen: 60,
      colors: { body: '#c8a850', back: '#8a6f20', belly: '#f4ecd0', fin: '#a88f38', pattern: '#3fa8f0' },
      desc: '背上那些藍點在沙裡幾乎看不見，只有牠掀起來游走的那一秒會全部亮出來。那是警告尾刺的最後通牒。' },
    { id: 'cr_unicorn', name: '獨角鼻魚', rarity: 'rare', shape: 'wide', scale: 1.02, pattern: 'none', mult: 2.23, minLen: 30, maxLen: 62,
      special: ['horn'],
    ...
    /* --- 史詩 --- */
    { id: 'cr_mantajuv', name: '幼蝠鱝', rarity: 'epic', shape: 'ray', scale: 1.12, pattern: 'none', mult: 6.59, minLen: 70, maxLen: 160,
      special: ['glow'],
    ...
    { id: 'cr_seadragon', name: '葉形海龍', rarity: 'epic', shape: 'long', scale: 1.06, pattern: 'net', mult: 6.46, minLen: 20, maxLen: 45,
      special: ['glow'],
    ...
    /* --- 傳說 --- */
    { id: 'cr_prism', name: '稜鏡鸚鯛', rarity: 'legend', shape: 'flat', scale: 1.16, pattern: 'scale', mult: 20.4, minLen: 35, maxLen: 78,
      special: ['glow'],
      ...
      desc: '天一黑，牠會把顏色關掉。' },
    { id: 'cr_shadowray', name: '暗礁蝠鱝', rarity: 'legend', shape: 'ray', scale: 1.22, pattern: 'none', mult: 19.9, minLen: 180, maxLen: 400,
      special: ['glow'],
    ...
    /* --- 魚王 --- */
    { id: 'cr_king_ruri', name: '虹鱗蘇眉「琉璃」', rarity: 'king', shape: 'wrasse', scale: 1.32, pattern: 'scale', mult: 76.8, minLen: 140, maxLen: 250,
  ...
  const CAVERN_FISH = [
    /* --- 雜物 --- */
    { id: 'cv_dripstone', name: '斷落的鐘乳石', rarity: 'junk', junkArt: 'dripstone', mult: 0.0324, minLen: 12, maxLen: 40, unit: 'cm', desc: '斷面上一圈一圈的層理，一圈大約一百年。這一根數得出六十幾圈。' },
    { id: 'cv_can',   name: '熄滅乙炔燈',     rarity: 'junk', junkArt: 'cv_lamp', mult: 0.0236, minLen: 6, maxLen: 12, unit: 'cm', desc: '反光罩覆滿白色鐘乳垢，燈芯泡在洞水裡，像一小撮黑毛。' },
    { id: 'cv_ladder', name: '鏽蝕岩釘環',   rarity: 'junk', junkArt: 'cv_ropeanchor', mult: 0.0258, minLen: 50, maxLen: 150, unit: 'cm', desc: '圓環仍拴著三段發白細繩，末端卻都斷在摸不到的黑暗裡。' },

    /* --- 普通 --- */
    { id: 'cv_blindloach', name: '無眼平鰍', rarity: 'common', shape: 'long', scale: .68, pattern: 'none', mult: 0.283, minLen: 5, maxLen: 13,
      special: ['blind'],
      colors: { body: '#f0e0dc', back: '#c8b0aa', belly: '#fbf4f2', fin: '#e0cac4' },
      desc: '牠失去的是眼睛。眼窩還在，上面長了一層皮，摸得出來底下是空的。' },
    { id: 'cv_whitegoby', name: '白化吻鰕虎', rarity: 'common', shape: 'torpedo', scale: .62, pattern: 'none', mult: 0.279, minLen: 4, maxLen: 10,
      special: ['blind'],
      colors: { body: '#f4e8e4', back: '#d0bab6', belly: '#fefaf8', fin: '#e8d6d2' },
      desc: '牠失去的是色素。洞外的同種是土褐色的，這裡的每一條都是這個顏色，一條例外都沒有。' },
    { id: 'cv_cavecarp', name: '盲鯉', rarity: 'common', shape: 'normal', scale: .74, pattern: 'none', mult: 0.284, minLen: 8, maxLen: 20,
      special: ['blind'],
      colors: { body: '#f0dcd4', back: '#c8aaa0', belly: '#fbf2ee', fin: '#dfc4bc' },
      desc: '牠失去的是晝夜。洞裡沒有天亮這件事，所以牠一天二十四小時平均地吃、平均地睡，沒有任何一段是「白天」。' },
    { id: 'cv_translucent', name: '透體鰷', rarity: 'common', shape: 'torpedo', scale: .66, pattern: 'none', mult: 0.282, minLen: 4, maxLen: 11,
      special: ['blind'],
      colors: { body: '#f8eeea', back: '#dcc6c2', belly: '#ffffff', fin: '#eeddd8', pattern: '#e0a8a0' },
      desc: '牠失去的是不透明。撈起來對著頭燈看，脊椎一節一節數得出來，心臟在哪裡也看得見。' },
    { id: 'cv_flatfin', name: '扁鰭穴魚', rarity: 'common', shape: 'flat', scale: .70, pattern: 'none', mult: 0.286, minLen: 5, maxLen: 12,
      special: ['blind'],
      colors: { body: '#f2e2e0', back: '#cbb2b0', belly: '#fdf6f5', fin: '#e4d0ce' },
      desc: '牠失去的是速度。洞裡沒有東西追牠，所以肌肉退化成剛好夠移動的程度，游起來像在漂。' },
    { id: 'cv_mudsucker', name: '泥食盲鮈', rarity: 'common', shape: 'round', scale: .68, pattern: 'none', mult: 0.279, minLen: 5, maxLen: 13,
      special: ['blind'],
      colors: { body: '#eee0d8', back: '#c6aca4', belly: '#faf2ee', fin: '#dcc8c0' },
      desc: '牠失去的是選擇。洞裡的食物只有一種——從上面滴下來的東西沉在底泥裡，牠就吃那個。' },

    /* --- 優良 --- */
    { id: 'cv_barbel', name: '長鬚盲鮠', rarity: 'good', shape: 'long', scale: .88, pattern: 'none', mult: 0.584, minLen: 14, maxLen: 32,
    ...
    { id: 'cv_paleeel', name: '乳白穴鰻', rarity: 'good', shape: 'slim', scale: .92, pattern: 'none', mult: 0.576, minLen: 30, maxLen: 70,
      special: ['blind'],
      colors: { body: '#f6ece8', back: '#d4bcb8', belly: '#ffffff', fin: '#e8d8d4' },
      desc: '牠失去的是回頭的路。牠是從外面游進來的，進來以後在黑暗裡待了太久，現在游到洞口那一段光裡牠會立刻退回去。' },
    { id: 'cv_swimless', name: '無鰾底棲魚', rarity: 'good', shape: 'round', scale: .86, pattern: 'none', mult: 0.586, minLen: 10, maxLen: 24,
      special: ['blind'],
      colors: { body: '#ecdcd6', back: '#c2a8a2', belly: '#f8f0ec', fin: '#dac6c0' },
      desc: '牠失去的是鰾。沒有鰾就浮不起來，所以牠一輩子貼著底，連睡覺都是趴著。' },
    { id: 'cv_needle', name: '針嘴盲鱂', rarity: 'good', shape: 'long', scale: .82, pattern: 'none', mult: 0.58, minLen: 8, maxLen: 18,
      special: ['blind'],
      colors: { body: '#f4e6e0', back: '#d0b6b0', belly: '#fdf7f4', fin: '#e6d2cc' },
      desc: '牠失去的是咬合力。嘴退化成一根細管，只能吸——吸那些小到不需要咬的東西。' },
    { id: 'cv_platefin', name: '盤鰭穴鰈', rarity: 'good', shape: 'flat', scale: .88, pattern: 'none', mult: 0.575, minLen: 12, maxLen: 28,
      special: ['blind'],
      colors: { body: '#f2e4de', back: '#cab0aa', belly: '#fcf6f3', fin: '#e2d0ca' },
      desc: '牠失去的是方向感——或者說，牠不需要了。洞裡沒有上下的線索，牠側著游、翻著游都一樣，沒有哪一面是正面。' },

    /* --- 稀有 --- */
    { id: 'cv_redgill', name: '赤鰓盲鰍', rarity: 'rare', shape: 'long', scale: 1.00, pattern: 'none', mult: 1.76, minLen: 12, maxLen: 28,
      special: ['blind', 'gills'],
      colors: { body: '#f6e8e4', back: '#d2bab6', belly: '#fffbfa', fin: '#e8d6d2', gill: '#e0505f' },
      desc: '整條魚身上唯一的顏色是頭後那三叢外鰓——那不是色素，是血。洞水的溶氧低到牠得把鰓翻到外面來。' },
    { id: 'cv_jadecarp', name: '白玉盲鯉', rarity: 'rare', shape: 'normal', scale: 1.02, pattern: 'none', mult: 1.74, minLen: 22, maxLen: 50,
      special: ['blind'],
      colors: { body: '#f8f0ea', back: '#d8c8c0', belly: '#ffffff', fin: '#ebdfd8' },
      desc: '離水以後牠的身體會在幾分鐘內失去光澤，變成一種霧霧的白。所以帶出洞的標本沒有一件像本人。' },
    { id: 'cv_longfin', name: '長鰭穴鮠', rarity: 'rare', shape: 'slim', scale: 1.04, pattern: 'none', mult: 1.77, minLen: 25, maxLen: 58,
      special: ['blind', 'whisker'],
      colors: { body: '#f2e2da', back: '#cbb0a8', belly: '#fdf6f2', fin: '#e4cec6' },
      desc: '鰭緣拉得又長又薄，薄到透光。牠不用鰭划水，牠用鰭感覺水——水一動牠就知道有多大的東西在多遠的地方。' },
    { id: 'cv_slowgrow', name: '百歲盲鱒', rarity: 'rare', shape: 'wide', scale: 1.02, pattern: 'none', mult: 1.73, minLen: 28, maxLen: 62,
      special: ['blind'],
      colors: { body: '#f0e4dc', back: '#c8b2aa', belly: '#fbf6f2', fin: '#e0d0c8' },
      desc: '洞裡的東西少，所以牠長得極慢——這一條的耳石切開來數，五十三年。牠現在的長度是外面同種三年的長度。' },

    /* --- 史詩 --- */
    { id: 'cv_armored', name: '鎧甲盲鱘', rarity: 'epic', shape: 'wide', scale: 1.10, pattern: 'net', mult: 6.56, minLen: 60, maxLen: 130,
      special: ['blind', 'spike'],
    ...
    { id: 'cv_dripeater', name: '食滴白鰻', rarity: 'epic', shape: 'long', scale: 1.08, pattern: 'none', mult: 6.38, minLen: 70, maxLen: 150,
      special: ['blind'],
      colors: { body: '#f8f2ee', back: '#d8c8c2', belly: '#ffffff', fin: '#eae0da' },
      desc: '牠整天待在鐘乳石正下方，等水滴。每一滴會帶下來一點洞頂的有機物，一天大概兩百滴。牠算得出下一滴什麼時候到。' },

    /* --- 傳說 --- */
    { id: 'cv_silentfin', name: '無聲白鰭', rarity: 'legend', shape: 'flat', scale: 1.18, pattern: 'none', mult: 29.7, minLen: 45, maxLen: 100,
      special: ['blind'],
    ...
    { id: 'cv_relict', name: '遺留種盲鰻', rarity: 'legend', shape: 'long', scale: 1.20, pattern: 'none', mult: 29.3, minLen: 90, maxLen: 190,
      special: ['blind', 'gills'],
    ...
    /* --- 魚王 --- */
    { id: 'cv_king_chosoku', name: '盲穴白龍「長息」', rarity: 'king', shape: 'olm', scale: 1.26, pattern: 'none', mult: 159, minLen: 200, maxLen: 380,
  ...
  const DAWN_PORT_FISH = [
    /* --- 雜物 --- */
    { id: 'dp_porthole', name: '碎裂的舷窗', rarity: 'junk', junkArt: 'porthole', mult: 0.0284, minLen: 22, maxLen: 40, unit: 'cm', desc: '銅環還是亮的，玻璃裂成一片蛛網但沒有掉。蝶形螺栓鎖著，所以它是從船上整片脫落的，不是被人拆下來的。' },
    { id: 'dp_can',      name: '沉船信號燈', rarity: 'junk', junkArt: 'dp_signallamp', mult: 0.0232, minLen: 8, maxLen: 16, unit: 'cm', desc: '黃銅護框還在，紅色玻璃裂成四瓣，裡面的燈芯早就被海水沖走。' },
    { id: 'dp_plank',    name: '卡死的黃銅羅盤', rarity: 'junk', junkArt: 'dp_compass', mult: 0.0254, minLen: 30, maxLen: 70, unit: 'cm', desc: '指針永遠停在東北方，透明蓋下壓著一粒船艙裡才有的藍色漆屑。' },

    /* --- 普通 --- */
    { id: 'dp_tyregoby', name: '輪胎鰕虎', rarity: 'common', shape: 'long', scale: .70, pattern: 'speck', mult: 0.263, minLen: 6, maxLen: 15,
    ...
    { id: 'dp_pipeblenny', name: '排管鳚', rarity: 'common', shape: 'long', scale: .66, pattern: 'band', mult: 0.265, minLen: 5, maxLen: 12,
    ...
    { id: 'dp_rustsculpin', name: '鏽斑杜父魚', rarity: 'common', shape: 'round', scale: .74, pattern: 'spot', mult: 0.261, minLen: 7, maxLen: 17,
      colors: { body: '#8a5f3f', back: '#5a3524', belly: '#b89070', fin: '#70452c', pattern: '#3f2418' },
      desc: '牠貼在船殼的鏽蝕面上，身上那一片一片的斑跟鏽的邊緣完全一樣。牠不是像鏽，牠是照著那一塊鏽長的。' },
    { id: 'dp_bilgesprat', name: '艙底小鯡', rarity: 'common', shape: 'torpedo', scale: .62, pattern: 'stripe', mult: 0.266, minLen: 4, maxLen: 10,
      colors: { body: '#8f9a96', back: '#4f5a58', belly: '#cfd8d4', fin: '#6f7a76', pattern: '#3f4a48' },
      desc: '牠住在灌滿水的艙底，成千上萬條。那裡沒有光，但有從上面漏下來的東西可以吃，所以牠們不出去。' },
    { id: 'dp_bottlecardinal', name: '瓶棲天竺鯛', rarity: 'common', shape: 'flat', scale: .68, pattern: 'band2', mult: 0.26, minLen: 5, maxLen: 11,
      colors: { body: '#a87a5a', back: '#6a4432', belly: '#d8b090', fin: '#8a5f44', pattern: '#4a2c1e' },
      desc: '牠住在沉下去的玻璃瓶裡，一瓶一條，頭朝瓶口。港裡的瓶子比洞多，所以牠是這一帶數量第二多的魚。' },
    { id: 'dp_platefin', name: '鐵板鰈', rarity: 'common', shape: 'flat', scale: .72, pattern: 'speck', mult: 0.264, minLen: 6, maxLen: 14,
      colors: { body: '#6f6a5f', back: '#43403a', belly: '#a09a8c', fin: '#5a564d', pattern: '#332f2a' },
      desc: '牠一輩子貼在一塊平的鐵板上，身體壓得比同種還扁。鐵板是什麼形狀，牠就是什麼形狀。' },

    /* --- 優良 --- */
    { id: 'dp_hoseeel', name: '膠管鰻', rarity: 'good', shape: 'slim', scale: .92, pattern: 'none', mult: 0.552, minLen: 28, maxLen: 66,
      colors: { body: '#4f4a44', back: '#2a2724', belly: '#7a7268', fin: '#3f3a35' },
      desc: '牠住在一條橡膠管裡，整條身體剛好填滿。管子已經比牠的身體軟，所以牠現在是那條管子的形狀。' },
    { id: 'dp_containergrouper', name: '貨櫃石斑', rarity: 'good', shape: 'boxy', scale: .90, pattern: 'net', mult: 0.559, minLen: 22, maxLen: 52,
    ...
    { id: 'dp_ladderbass', name: '梯間鱸', rarity: 'good', shape: 'normal', scale: .88, pattern: 'stripe', mult: 0.549, minLen: 20, maxLen: 46,
    ...
    { id: 'dp_dieselmullet', name: '油膜鯔', rarity: 'good', shape: 'torpedo', scale: .94, pattern: 'scale', mult: 0.561, minLen: 26, maxLen: 60,
      colors: { body: '#8a8f7a', back: '#4f5544', belly: '#c8ccb4', fin: '#6f7460', pattern: '#3a3f30' },
      desc: '牠在水面下十公分吃那層油膜底下的東西。撈上來的時候鱗片會有一圈虹彩——那不是牠的顏色，那是油。' },
    { id: 'dp_anchorbream', name: '錨鏈鯛', rarity: 'good', shape: 'flat', scale: .90, pattern: 'band', mult: 0.555, minLen: 18, maxLen: 42,
      colors: { body: '#9a8f7f', back: '#5a5044', belly: '#d0c8b4', fin: '#7a7060', pattern: '#43392e' },
      desc: '錨鏈在水裡是一整座垂直的城，每一環都是一個房間。牠住在水深六公尺那一環，年年都是那一環。' },

    /* --- 稀有 --- */
    { id: 'dp_signalsnapper', name: '信號旗笛鯛', rarity: 'rare', shape: 'normal', scale: 1.02, pattern: 'band', mult: 1.72, minLen: 30, maxLen: 68,
    ...
    { id: 'dp_hazardtrigger', name: '警示紋鱗魨', rarity: 'rare', shape: 'flat', scale: 1.04, pattern: 'stripe', mult: 1.75, minLen: 24, maxLen: 56,
      special: ['spike'],
    ...
    { id: 'dp_redleadconger', name: '鉛丹穴鰻', rarity: 'rare', shape: 'slim', scale: 1.08, pattern: 'none', mult: 1.71, minLen: 45, maxLen: 105,
      colors: { body: '#c86a3a', back: '#7f3518', belly: '#e8a878', fin: '#a4522a' },
      desc: '牠住在塗滿鉛丹的艙壁縫裡，整條身體是那個橘。刮一塊鱗下來檢驗，橘色是牠自己長出來的，不是沾上去的。' },
    { id: 'dp_bluecabin', name: '艙藍石狗公', rarity: 'rare', shape: 'round', scale: 1.02, pattern: 'spot', mult: 1.73, minLen: 22, maxLen: 50,
      special: ['spike'],
    ...
    /* --- 傳說 --- */
    { id: 'dp_cabinguard', name: '留艙白鮸', rarity: 'legend', shape: 'wide', scale: 1.20, pattern: 'none', mult: 30.6, minLen: 100, maxLen: 220,
      special: ['glow'],
    ...
    { id: 'dp_chainconger', name: '鏈艙巨鰻', rarity: 'legend', shape: 'long', scale: 1.22, pattern: 'scale', mult: 31, minLen: 160, maxLen: 340,
      special: ['glow', 'jaw'],
    ...
    { id: 'dp_king_sunrise', name: '圓圓的太陽升起', rarity: 'king', shape: 'octopus', scale: 1.20, pattern: 'speck', mult: 169, minLen: 180, maxLen: 400,
  ...
  const MAPLE_KEEP_FISH = [
    { id: 'mk_kawara', name: '楓印鬼瓦片', rarity: 'junk', junkArt: 'mk_kawara', mult: 0.0224, minLen: 16, maxLen: 28, unit: 'cm', desc: '從天守屋脊落進護城河的瓦片，凹槽裡卡著一枚乾透的楓葉。' },
    { id: 'mk_hairpin', name: '朱漆楓髮簪', rarity: 'junk', junkArt: 'mk_hairpin', mult: 0.0274, minLen: 12, maxLen: 19, unit: 'cm', desc: '漆色被水磨得發暗，楓形墜子卻還在水下閃著一點金。' },
    { id: 'mk_leafnet', name: '落葉手抄網', rarity: 'junk', junkArt: 'mk_leafnet', mult: 0.02, minLen: 24, maxLen: 40, unit: 'cm', desc: '城下人撈落葉用的小網，現在反而被一整袋紅葉拖在河底。' },

    { id: 'mk_medaka', name: '城濠青鱂', rarity: 'common', shape: 'slim', scale: .62, pattern: 'stripe', mult: 0.215, minLen: 3, maxLen: 5, colors: { body: '#c8d4d8', back: '#687984', belly: '#f2efe0', fin: '#aeb9bc', pattern: '#8aa4ae' }, desc: '貼著石垣陰影游動，太陽一斜就像碎銀一樣整群亮起來。' },
    { id: 'mk_moroko', name: '石間諸子', rarity: 'common', shape: 'slim', scale: .66, pattern: 'speck', mult: 0.245, minLen: 6, maxLen: 12, colors: { body: '#a89470', back: '#62523c', belly: '#e7dcc2', fin: '#8f7958', pattern: '#4e4218' }, desc: '把卵黏在護城河的碎石間，城牆修過幾次，牠們就搬過幾次家。' },
    { id: 'mk_motsugo', name: '楓影麥穗', rarity: 'common', shape: 'torpedo', scale: .68, pattern: 'saddle', mult: 0.227, minLen: 7, maxLen: 14, colors: { body: '#9d936f', back: '#57543a', belly: '#ded7b7', fin: '#81794f', pattern: '#343824' }, desc: '嘴朝上翹，專門撿水面剛落下來、還沒沉底的小蟲。' },
    { id: 'mk_goby', name: '朱砂川鰕虎', rarity: 'common', shape: 'clinger', scale: .70, pattern: 'band', mult: 0.257, minLen: 6, maxLen: 13, colors: { body: '#a56b35', back: '#5f3f25', belly: '#d9b37a', fin: '#8c592e', pattern: '#4a2c1e' }, desc: '胸鰭貼在石面上，像兩枚小小的橘紅扇子。' },
    { id: 'mk_crucian', name: '金濠鯽', rarity: 'common', shape: 'round', scale: .76, pattern: 'scale', mult: 0.268, minLen: 14, maxLen: 29, colors: { body: '#b8a268', back: '#70603b', belly: '#eadcad', fin: '#947b45', pattern: '#8c743d' }, desc: '在夕照裡整條會變成暗金色，是城濠裡最不怕人的魚。' },
    { id: 'mk_dojo', name: '瓦溝泥鰍', rarity: 'common', shape: 'long', scale: .70, pattern: 'band2', mult: 0.202, minLen: 8, maxLen: 18, special: ['whisker'], colors: { body: '#92704b', back: '#503b2a', belly: '#d8c09a', fin: '#75583c', pattern: '#332a20' }, desc: '大雨後會鑽進排水瓦溝，水退了再一條一條滑回護城河。' },

    { id: 'mk_dace', name: '赤鰭雅羅', rarity: 'good', shape: 'torpedo', scale: .82, pattern: 'stripe', mult: 0.467, minLen: 18, maxLen: 36, colors: { body: '#bbc7ca', back: '#667780', belly: '#f1eee2', fin: '#c96045', pattern: '#788f96' }, desc: '尾鰭與腹鰭帶著紅邊，逆著城門下的暗流停在原地。' },
    { id: 'mk_ayu', name: '落楓香魚', rarity: 'good', shape: 'normal', scale: .84, pattern: 'gradient', mult: 0.524, minLen: 19, maxLen: 34, colors: { body: '#9c9370', back: '#59543c', belly: '#e5d7a8', fin: '#b0904d', pattern: '#d8a45c' }, desc: '腹側有一抹楓黃，離水時仍帶著淡淡的瓜香。' },
    { id: 'mk_catfish', name: '短鬚城鯰', rarity: 'good', shape: 'catfish', scale: .92, pattern: 'none', mult: 0.558, minLen: 30, maxLen: 66, special: ['whisker'], colors: { body: '#4b5052', back: '#292e30', belly: '#9a9890', fin: '#3c4142', pattern: '#686867' }, desc: '白天躲在石垣最深的縫裡，天守一關燈才出來繞城。' },
    { id: 'mk_maplekoi', name: '楓紋白鯉', rarity: 'good', shape: 'koi', scale: .90, pattern: 'spot', mult: 0.501, minLen: 28, maxLen: 61, special: ['whisker'], colors: { body: '#eee9df', back: '#c9c0b2', belly: '#fffdf7', fin: '#d8d0c6', pattern: '#c8422f' }, desc: '白地上散著楓葉般的紅斑，據說每一條的圖樣都不會重複。' },
    { id: 'mk_eel', name: '銅濠鰻', rarity: 'good', shape: 'serpent', scale: .94, pattern: 'gradient', mult: 0.512, minLen: 42, maxLen: 96, colors: { body: '#6e512d', back: '#322819', belly: '#b89762', fin: '#493820', pattern: '#c28a3f' }, desc: '在橋腳與石垣間穿行，濕亮的背像一條剛擦過的銅索。' },

    { id: 'mk_masu', name: '城門櫻鱒', rarity: 'rare', shape: 'leaper', scale: 1.02, pattern: 'stripe', mult: 1.51, minLen: 38, maxLen: 74, colors: { body: '#aeb9be', back: '#46525b', belly: '#ecede7', fin: '#b84936', pattern: '#c94c38' }, desc: '只有開閘換水時才逆流進城，銀身下壓著一道深紅。' },
    { id: 'mk_castlebream', name: '黑金城鯛', rarity: 'rare', shape: 'flat', scale: 1.00, pattern: 'scale', mult: 1.7, minLen: 31, maxLen: 59, colors: { body: '#34373a', back: '#181b1e', belly: '#81755c', fin: '#25282b', pattern: '#c3953d' }, desc: '鱗片邊緣像描了金，游過陰影時只剩一圈輪廓還亮著。' },
    { id: 'mk_coppertrout', name: '銅葉川鱒', rarity: 'rare', shape: 'wide', scale: 1.02, pattern: 'spot', mult: 1.61, minLen: 34, maxLen: 68, colors: { body: '#a85a36', back: '#603426', belly: '#dec0a0', fin: '#82402c', pattern: '#d9984a' }, desc: '側斑像一列被雨打濕的銅楓葉，入冬後會全部轉暗。' },
    { id: 'mk_stonepike', name: '石垣錦蛇魚', rarity: 'rare', shape: 'pike', scale: 1.04, pattern: 'net', mult: 1.77, minLen: 52, maxLen: 105, special: ['jaw'], colors: { body: '#667052', back: '#333b2a', belly: '#c0b28b', fin: '#4c563b', pattern: '#d0bd79' }, desc: '身上的菱紋與城牆砌法一模一樣，伏在牆邊時幾乎看不出來。' },
    ...
    { id: 'mk_wall_eel', name: '百間石垣鰻', rarity: 'epic', shape: 'serpent', scale: 1.16, pattern: 'band2', mult: 6.84, minLen: 95, maxLen: 210, special: ['scar'], colors: { body: '#303235', back: '#151719', belly: '#8b8176', fin: '#232527', pattern: '#b5a58e' }, desc: '傳說牠沿著整面城牆盤了一圈，身上的白帶就是每一道轉角。' },

    { id: 'mk_shachihoko', name: '金鯱御影', rarity: 'legend', shape: 'crest', scale: 1.24, pattern: 'stripe', mult: 29.1, minLen: 72, maxLen: 138, special: ['horn', 'glow'], colors: { body: '#d6a52e', back: '#7f5314', belly: '#f7e083', fin: '#e6ba40', pattern: '#292015', glow: '#ffd76a' }, desc: '屋脊金鯱在暴雨夜留下的一道水影。牠躍起時，天守的避雷針會一起發亮。' },
    { id: 'mk_sunsettrout', name: '落日緋天魚', rarity: 'legend', shape: 'leaper', scale: 1.26, pattern: 'gradient', mult: 33.2, minLen: 68, maxLen: 132, special: ['glow', 'kype'], colors: { body: '#c93c2d', back: '#6f1f1c', belly: '#f0a548', fin: '#df5230', pattern: '#ffd05a', glow: '#ffb347' }, desc: '把護城河最後一段夕光收進側線，太陽沉下去後才肯咬鉤。' },
    { id: 'mk_king_momijigari', name: '楓鬼大鯰「紅葉狩」', rarity: 'king', shape: 'oni_catfish', scale: 1.42, pattern: 'spot', mult: 174, minLen: 180, maxLen: 420, special: ['glow', 'whisker', 'horn', 'scar'], colors: { body: '#20191a', back: '#0d0a0b', belly: '#6a3b2d', fin: '#3b1718', pattern: '#d53a24', glow: '#ff6a2a' }, desc: '天守最早的一塊礎石下就住著牠。頭鰭像折角兜鍪，滿身楓火，每次現身都把整條護城河染成赤色。' }
  ];
  ...
  const FOX_SPRINGS_FISH = [
    { id: 'fs_yunohana', name: '青白湯之花', rarity: 'junk', junkArt: 'fs_yunohana', mult: 0.0208, minLen: 9, maxLen: 17, unit: 'cm', desc: '溫泉礦物在黑石上結成的柔白團塊，曬乾後會碎成一層細粉。' },
    { id: 'fs_ema', name: '無字狐繪馬', rarity: 'junk', junkArt: 'fs_ema', mult: 0.0256, minLen: 12, maxLen: 18, unit: 'cm', desc: '沒有願望也沒有署名，只有紅繩在水下慢慢擺動。' },
    { id: 'fs_geta', name: '雪埋杉木屐', rarity: 'junk', junkArt: 'fs_geta', mult: 0.0184, minLen: 22, maxLen: 29, unit: 'cm', desc: '只剩左腳那一隻，齒縫裡的雪在熱水裡融了又結成白垢。' },

    { id: 'fs_onsenminnow', name: '湯腹小鰷', rarity: 'common', shape: 'slim', scale: .62, pattern: 'gradient', mult: 0.197, minLen: 4, maxLen: 8, colors: { body: '#c8d7db', back: '#718b96', belly: '#e4bd71', fin: '#a7b9bd', pattern: '#d8a45c' }, desc: '肚皮總比水溫暖一點，整群貼著湧泉口打轉。' },
    { id: 'fs_smelt', name: '雪溪公魚', rarity: 'common', shape: 'slim', scale: .66, pattern: 'stripe', mult: 0.219, minLen: 7, maxLen: 14, colors: { body: '#c7d6df', back: '#6b8296', belly: '#f3f7f8', fin: '#9fb5c2', pattern: '#87a7ba' }, desc: '一離水就像冰片般透亮，山裡人拿牠裹薄粉下鍋。' },
    { id: 'fs_sculpin', name: '黑石杜父魚', rarity: 'common', shape: 'clinger', scale: .74, pattern: 'speck', mult: 0.237, minLen: 7, maxLen: 16, colors: { body: '#806f5c', back: '#413a31', belly: '#b9aa93', fin: '#65584a', pattern: '#2f2a26' }, desc: '伏在火山石上不動，只有眼睛會跟著水面上的影子轉。' },
    { id: 'fs_dojo', name: '白斑泥鰍', rarity: 'common', shape: 'long', scale: .70, pattern: 'band', mult: 0.208, minLen: 9, maxLen: 19, special: ['whisker'], colors: { body: '#b4a98e', back: '#706552', belly: '#e8dfcc', fin: '#91846b', pattern: '#d9d3c2' }, desc: '身上的淡斑像積雪，在暗色砂底上反而特別顯眼。' },
    { id: 'fs_bitterling', name: '桃雪鰟鮍', rarity: 'common', shape: 'flat', scale: .68, pattern: 'gradient', mult: 0.248, minLen: 5, maxLen: 10, colors: { body: '#d3bbc0', back: '#827780', belly: '#f1e5df', fin: '#c79aa4', pattern: '#e7a8b3' }, desc: '冬季婚姻色像雪地裡落了一瓣極淡的桃花。' },
    { id: 'fs_goby', name: '霜紋川鰕虎', rarity: 'common', shape: 'clinger', scale: .70, pattern: 'stripe', mult: 0.187, minLen: 6, maxLen: 13, colors: { body: '#93a6ad', back: '#53656d', belly: '#dbe4e4', fin: '#778b92', pattern: '#bfd5dc' }, desc: '背上的白紋像薄霜，水一熱就會往更冷的支流退。' },

    { id: 'fs_yamame', name: '藍斑山女', rarity: 'good', shape: 'leaper', scale: .88, pattern: 'band', mult: 0.45, minLen: 18, maxLen: 37, colors: { body: '#aebdc4', back: '#586b77', belly: '#edf0eb', fin: '#9a786f', pattern: '#496779' }, desc: '橢圓幼斑泛著冷藍，是雪溪裡最敏捷的一道影子。' },
    { id: 'fs_iwana', name: '白星岩魚', rarity: 'good', shape: 'wide', scale: .90, pattern: 'spot', mult: 0.503, minLen: 22, maxLen: 48, colors: { body: '#5f5b50', back: '#302f2b', belly: '#b8ac91', fin: '#6f543d', pattern: '#d9d6bf' }, desc: '深色背上密布白星，只在積雪把山路封住後靠近湧泉。' },
    { id: 'fs_rainbow', name: '湯霞虹鱒', rarity: 'good', shape: 'wide', scale: .94, pattern: 'gradient', mult: 0.525, minLen: 28, maxLen: 62, colors: { body: '#aebfc8', back: '#4e6472', belly: '#edf2ef', fin: '#9b7b88', pattern: '#d88282' }, desc: '側線把紙窗的暖光拉成一條淡霞，游遠後又恢復銀灰。' },
    { id: 'fs_masu', name: '雪代櫻鱒', rarity: 'good', shape: 'leaper', scale: .96, pattern: 'saddle', mult: 0.482, minLen: 34, maxLen: 71, colors: { body: '#b8c5ca', back: '#546a78', belly: '#f1f2ec', fin: '#758aa0', pattern: '#79a7ca' }, desc: '融雪洪水來時逆流上山，身上的藍斑會被水沖成長條。' },
    { id: 'fs_burbot', name: '湯底江鱈', rarity: 'good', shape: 'catfish', scale: .96, pattern: 'speck', mult: 0.471, minLen: 32, maxLen: 76, special: ['whisker'], colors: { body: '#766a50', back: '#3b382c', belly: '#bbae8f', fin: '#5d543f', pattern: '#423d31' }, desc: '整天貼著最深的冷水層，只有夜裡會游進暖流邊緣覓食。' },

    { id: 'fs_redchar', name: '赤星霜岩魚', rarity: 'rare', shape: 'wide', scale: 1.04, pattern: 'spot', mult: 1.53, minLen: 37, maxLen: 78, special: ['frost'], colors: { body: '#3f4652', back: '#202731', belly: '#a9a7a0', fin: '#663d3c', pattern: '#ee6541' }, desc: '炭黑身體上燃著橙紅小星，所有鰭緣卻像結了一圈白霜。' },
    { id: 'fs_silverkoi', name: '銀雲羽衣鯉', rarity: 'rare', shape: 'koi', scale: 1.04, pattern: 'spot', mult: 1.64, minLen: 38, maxLen: 84, special: ['whisker'], colors: { body: '#edf2f3', back: '#b8c9d4', belly: '#ffffff', fin: '#d6e1e8', pattern: '#79a5c4' }, desc: '淡藍斑像冬空的雲，長鰭一擺就把水汽捲成細絲。' },
    { id: 'fs_snoweel', name: '雪帶白鰻', rarity: 'rare', shape: 'serpent', scale: 1.06, pattern: 'band2', mult: 1.73, minLen: 64, maxLen: 142, colors: { body: '#e0e3e2', back: '#879098', belly: '#faf7ed', fin: '#bec5c7', pattern: '#667681' }, desc: '白身上繞著灰藍雪帶，鑽進蒸氣裡就像一截會動的雲。' },
    { id: 'fs_salamander', name: '蒼斑大鯢', rarity: 'rare', shape: 'olm', scale: 1.08, pattern: 'spot', mult: 1.58, minLen: 48, maxLen: 118, special: ['limbs'], colors: { body: '#3c4755', back: '#222c38', belly: '#768493', fin: '#34404c', pattern: '#7197c3' }, desc: '趴在溫泉出口的黑石上，藍斑隨呼吸一明一暗。' },
    ...
    { id: 'fs_ninetailkoi', name: '九尾白狐鯉', rarity: 'legend', shape: 'koi', scale: 1.28, pattern: 'spot', mult: 30.3, minLen: 78, maxLen: 156, special: ['glow', 'whisker', 'horn'], colors: { body: '#f6f5ef', back: '#c8d9e6', belly: '#ffffff', fin: '#e5edf4', pattern: '#3978c0', glow: '#9fe8ff' }, desc: '尾鰭分成九道雪白長瓣，額上的藍紋像一張笑著的狐面。' },
    { id: 'fs_moonshadow', name: '月影星鮭', rarity: 'legend', shape: 'leaper', scale: 1.28, pattern: 'ocellus', mult: 34.5, minLen: 74, maxLen: 149, special: ['glow', 'kype'], colors: { body: '#172749', back: '#09142a', belly: '#55698b', fin: '#24365a', pattern: '#f4e5a6', glow: '#fff0b5' }, desc: '深藍側腹托著一輪彎月，周圍的細鱗像散開的星。' },
    { id: 'fs_king_hakugin', name: '白狐龍魚「白銀」', rarity: 'king', shape: 'kitsune_dragon', scale: 1.46, pattern: 'scale', mult: 184, minLen: 230, maxLen: 560, special: ['glow', 'horn', 'mane', 'filaments'], colors: { body: '#eef4f6', back: '#a9c8db', belly: '#ffffff', fin: '#dcecf4', pattern: '#d94a39', glow: '#8fe8ff' }, desc: '九道背鬃在雪夜裡展開，面紋像神社狐面。牠從不躲避人眼，因為看見牠的人都會忘記自己許過什麼願。' }
  ];
