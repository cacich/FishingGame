...
**五個釣點全部開放且免費切換**：晨霧湖 → 落霞峽灣 → 宵櫻神域 → 幽藍冰湖 → 深淵海溝，各 23～24 種魚（圖鑑分母 20～21）、各一位魚王、**各一種地形**（森林／崖壁／神域／冰原／夜海）。進程門檻由拋竿費（400 → 12,000）承擔，不收解鎖費。
...
| `js/pixel.js` | 1460 | 像素美術引擎（含地形系統） | [06](06-pixel-engine.md) |
| `js/data.js` | 725 | 所有資料表 | [07](07-data-schema.md) |
| `js/state.js` | 400 | 存檔／經濟／抽獎 | [02](02-state-and-save.md)、[03](03-economy.md) |
| `js/ui.js` | 120 | Toast／彈窗 | [08](08-ui-and-screens.md) |
| `js/screen-fishing.js` | 715 | 釣魚分頁＋自動模式 | [04](04-fishing-loop.md)、[05](05-auto-mode.md) |
| `js/screen-daily.js` | 130 | 每日分頁 | [08](08-ui-and-screens.md) |
| `js/screen-home.js` | 245 | 家園分頁 | [08](08-ui-and-screens.md) |
| `js/screen-shop.js` | 240 | 商店分頁 | [08](08-ui-and-screens.md) |
| `js/screen-codex.js` | 126 | 圖鑑分頁 | [08](08-ui-and-screens.md) |
