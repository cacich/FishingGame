...
| `FG.locationPicker()` | 頂部地點按鈕與每日頁共用的全螢幕釣點地圖庫。提供名稱／景觀／最低下注搜尋、全部／入門／進階／深釣篩選、目前釣點大型預覽、圖鑑進度與 2～3 欄釣點卡；點卡先預覽，再明確按「前往」才切換。細節見 [08 §釣點地圖庫](08-ui-and-screens.md#二--全螢幕釣點地圖庫--loc-atlas)。 |
